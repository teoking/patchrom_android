...
.field public static final KEY_PARAMETER_AML_PLAYER_FORCE_HARD_DECODE:I = 0x7d7

.field public static final KEY_PARAMETER_AML_PLAYER_FORCE_SOFT_DECODE:I = 0x7d8
...
.field public static final VIDEO_OUT_SOFT_RENDER:I = 0x0
...
# instance fields
.field private isEjectOrUnmoutProcessed:Z
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Landroid/media/MediaPlayer;->playType:Ljava/lang/String;

    const/4 v1, 0x0

    iput-boolean v1, p0, Landroid/media/MediaPlayer;->isEjectOrUnmoutProcessed:Z
    ...
    iput-object v1, p0, Landroid/media/MediaPlayer;->mMountReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$1000(Landroid/media/MediaPlayer;)Ljava/lang/String;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1100(Landroid/media/MediaPlayer;)Z
    ...
    .prologue
    iget-boolean v0, p0, Landroid/media/MediaPlayer;->isEjectOrUnmoutProcessed:Z
...
.method static synthetic access$1102(Landroid/media/MediaPlayer;Z)Z
    ...
    .prologue
    iput-boolean p1, p0, Landroid/media/MediaPlayer;->isEjectOrUnmoutProcessed:Z

    return p1
.end method

.method static synthetic access$1200(Landroid/media/MediaPlayer;)Landroid/media/MediaPlayer$EventHandler;
    .locals 1
    .parameter "x0"
...
.method public release()V
    ...
    const-string v3, "will update osd......"

    invoke-static {v2, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    const-string v1, "msgtype=endplay"

    .local v1, str:Ljava/lang/String;
    new-instance v0, Lcom/android/letvmanager/LetvManager;

    invoke-direct {v0, v4}, Lcom/android/letvmanager/LetvManager;-><init>(Landroid/content/Context;)V

    .local v0, manager:Lcom/android/letvmanager/LetvManager;
    invoke-virtual {v0}, Lcom/android/letvmanager/LetvManager;->isRunReportLog()Z

    move-result v2

    if-nez v2, :cond_0

    invoke-virtual {v0}, Lcom/android/letvmanager/LetvManager;->startReportLog()Z

    :cond_0
    invoke-virtual {v0, v1}, Lcom/android/letvmanager/LetvManager;->onReportLog(Ljava/lang/String;)Z

    invoke-direct {p0}, Landroid/media/MediaPlayer;->_release()V

    iget-object v2, p0, Landroid/media/MediaPlayer;->mMountReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v3, p0, Landroid/media/MediaPlayer;->mMountReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {v2, v3}, Landroid/content/Context;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V

    iput-object v4, p0, Landroid/media/MediaPlayer;->mMountReceiver:Landroid/content/BroadcastReceiver;
...
.method public setDataSource(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Map;)V
    ...
    iput-object v0, p0, Landroid/media/MediaPlayer;->playType:Ljava/lang/String;
...
.method public setDisplay(Landroid/view/SurfaceHolder;)V
    ...
    :goto_0
    invoke-direct {p0, v5}, Landroid/media/MediaPlayer;->_setVideoSurface(Landroid/view/Surface;)V

    invoke-direct {p0}, Landroid/media/MediaPlayer;->updateSurfaceScreenOn()V

    const-string v6, "media.p2pplay.enable"
    ...
    :cond_2
    invoke-interface {p1}, Landroid/view/SurfaceHolder;->getSurfaceContext()Landroid/content/Context;

    move-result-object v6

    iput-object v6, p0, Landroid/media/MediaPlayer;->mContext:Landroid/content/Context;

    invoke-interface {p1}, Landroid/view/SurfaceHolder;->getView()Landroid/view/View;

    move-result-object v6

    iput-object v6, p0, Landroid/media/MediaPlayer;->mView:Landroid/view/View;
    ...
    .local v3, mClassName:Ljava/lang/String;
    const-string v6, "MediaPlayer"
    ...
    const-string v8, "get classname is "
    ...
    .end local v3           #mClassName:Ljava/lang/String;
    ...
    iget-object v7, p0, Landroid/media/MediaPlayer;->mMountReceiver:Landroid/content/BroadcastReceiver;
    ...
    .restart local v3       #mClassName:Ljava/lang/String;
    ...
    const-string v6, "com.amlogic.store.classname"
...
.method public start()V
    ...
    const-string v4, "msgtype=startplay&offset="
    ...
    iget-object v4, p0, Landroid/media/MediaPlayer;->playType:Ljava/lang/String;
    ...
    invoke-direct {v0, v3}, Lcom/android/letvmanager/LetvManager;-><init>(Landroid/content/Context;)V
    ...
    :cond_0
    invoke-virtual {v0, v2}, Lcom/android/letvmanager/LetvManager;->onReportLog(Ljava/lang/String;)Z
