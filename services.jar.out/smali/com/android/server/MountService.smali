...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/MountService$ExtraInfoInternal;
    }
.end annotation
...
.field private static final DEBUG_KEY:Z = true
...
.field static final VOLUME_TYPE_FLASH:I = 0x2

.field static final VOLUME_TYPE_SATA:I = 0x4

.field static final VOLUME_TYPE_SDCARD:I = 0x1

.field static final VOLUME_TYPE_UMS:I = 0x3

.field static final VOLUME_TYPE_UNKNOWN:I = 0x0

.field private static final WATCHDOG_ENABLE:Z = false

.field private static final usbdescriptionId:I = 0x104050e
...
.field private final mExtraInfos:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.field private mNoUuidExternalStorageCount:I

.field private mNoUuidExternalStorageName:Ljava/lang/String;
...
.field private mUuidExternalStorageKeyMap:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.field private mUuidExternalStorageName:Ljava/lang/String;

.field private mUuidInternalStorageName:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v2, p0, Lcom/android/server/MountService;->mNoUuidExternalStorageCount:I

    const-string v0, "Internal"

    iput-object v0, p0, Lcom/android/server/MountService;->mUuidInternalStorageName:Ljava/lang/String;

    const-string v0, "External"

    iput-object v0, p0, Lcom/android/server/MountService;->mUuidExternalStorageName:Ljava/lang/String;

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v1, p0, Lcom/android/server/MountService;->mUuidExternalStorageName:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/server/MountService;->mNoUuidExternalStorageName:Ljava/lang/String;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/MountService;->mUuidExternalStorageKeyMap:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lcom/android/server/MountService;->mExtraInfos:Ljava/util/HashMap;
    ...
    iput-object v4, p0, Lcom/android/server/MountService;->mPrevAsecMountSet:[Ljava/lang/String;
...
.method static synthetic access$1500(Lcom/android/server/MountService;)Ljava/util/Map;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1708(Lcom/android/server/MountService;)I
    .locals 2
    .parameter "x0"

    .prologue
    iget v0, p0, Lcom/android/server/MountService;->storageindex:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, Lcom/android/server/MountService;->storageindex:I

    return v0
.end method

.method static synthetic access$1800(Lcom/android/server/MountService;Landroid/os/storage/StorageVolume;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"

    .prologue
    invoke-direct {p0, p1}, Lcom/android/server/MountService;->addVolumeLocked(Landroid/os/storage/StorageVolume;)V

    return-void
.end method

.method static synthetic access$1900(Lcom/android/server/MountService;)Ljava/util/HashMap;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$2100(Lcom/android/server/MountService;)Ljava/util/HashMap;
    ...
    .prologue
    iget-object v0, p0, Lcom/android/server/MountService;->mExtraInfos:Ljava/util/HashMap;
...
.method static synthetic access$2200(Lcom/android/server/MountService;Landroid/os/storage/StorageVolume;)V
    ...
    .prologue
    invoke-direct {p0, p1}, Lcom/android/server/MountService;->addNewVolume(Landroid/os/storage/StorageVolume;)V
...
.method static synthetic access$2600(Lcom/android/server/MountService;Ljava/lang/String;)I
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2700(Lcom/android/server/MountService;)Z
    .locals 1
    .parameter "x0"
...
.method static synthetic access$500(Lcom/android/server/MountService;Lcom/android/server/MountService$UnmountCallBack;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private addNewVolume(Landroid/os/storage/StorageVolume;)V
    .locals 5
    .parameter "newVolume"
    ...
    :cond_3
    invoke-virtual {p1, v0}, Landroid/os/storage/StorageVolume;->setStorageId(I)V

    iget-object v2, p0, Lcom/android/server/MountService;->mVolumeMap:Ljava/util/HashMap;
...
.method private deleteOldVolume(Landroid/os/storage/StorageVolume;)V
    .locals 5
    .parameter "oldVolume"
...
.method private doMountVolume(Ljava/lang/String;)I
    ...
    iget v3, v0, Lcom/android/server/MountService;->storageindex:I

    add-int/lit8 v4, v3, 0x1

    move-object/from16 v0, p0

    iput v4, v0, Lcom/android/server/MountService;->storageindex:I
    ...
    iget-object v3, v0, Lcom/android/server/MountService;->mConnector:Lcom/android/server/NativeDaemonConnector;
    ...
    .local v15, e:Lcom/android/server/NativeDaemonConnectorException;
    const/4 v13, 0x0

    .local v13, action:Ljava/lang/String;
    invoke-virtual {v15}, Lcom/android/server/NativeDaemonConnectorException;->getCode()I
    ...
    invoke-direct {v0, v13, v1, v3}, Lcom/android/server/MountService;->sendStorageIntent(Ljava/lang/String;Landroid/os/storage/StorageVolume;Landroid/os/UserHandle;)V
    ...
    const-string v13, "android.intent.action.MEDIA_NOFS"
...
.method private doShareUnshareVolume(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    const-string v5, "mUmsEnablingVolumes.remove"
    ...
    const-string v4, "mUmsEnablingVolumes.isEmpty, notifying"
...
.method private doUnmountVolume(Ljava/lang/String;ZZ)I
    ...
    sget-object v4, Lcom/android/server/MountService;->EXTERNAL_STORAGE_PATH:Ljava/lang/String;
    ...
    const-string v9, "mAsecMountSet.clear, size="
...
.method private finishMediaUpdate(Lcom/android/server/MountService$UnmountCallBack;)V
    ...
    const-string v2, "finishMediaUpdate("

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, p1, Lcom/android/server/MountService$UnmountCallBack;->path:Ljava/lang/String;
...
.method private getName(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget v2, p0, Lcom/android/server/MountService;->mNoUuidExternalStorageCount:I
    ...
    iget-object v3, p0, Lcom/android/server/MountService;->mNoUuidExternalStorageName:Ljava/lang/String;

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Lcom/android/server/MountService;->mNoUuidExternalStorageCount:I
    ...
    :cond_2
    iget-object v2, p0, Lcom/android/server/MountService;->mUuidExternalStorageKeyMap:Ljava/util/HashMap;
    ...
    iget-object v3, p0, Lcom/android/server/MountService;->mUuidExternalStorageName:Ljava/lang/String;
...
.method private handleSystemReady()V
    ...
    sget-object v7, Lcom/android/server/MountService;->EXTERNAL_STORAGE_PATH:Ljava/lang/String;
    ...
    invoke-direct {p0, v14, v2, v11, v13}, Lcom/android/server/MountService;->notifyVolumeStateChange(Ljava/lang/String;Ljava/lang/String;II)V
...
.method private notifyVolumeStateChange(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    iget v4, v0, Lcom/android/server/MountService;->storageindex:I

    add-int/lit8 v5, v4, 0x1

    move-object/from16 v0, p0

    iput v5, v0, Lcom/android/server/MountService;->storageindex:I
    ...
    const-string v6, "notifyVolumeStateChange old state="
    ...
    iget-object v5, v0, Lcom/android/server/MountService;->mExtraInfos:Ljava/util/HashMap;
    ...
    iget-object v4, v0, Lcom/android/server/MountService;->mExtraInfos:Ljava/util/HashMap;
    ...
    invoke-direct {v0, v14, v1, v4}, Lcom/android/server/MountService;->sendStorageIntent(Ljava/lang/String;Landroid/os/storage/StorageVolume;Landroid/os/UserHandle;)V
    ...
    invoke-direct {v0, v3}, Lcom/android/server/MountService;->addNewVolume(Landroid/os/storage/StorageVolume;)V
    ...
    const-string v14, "android.intent.action.MEDIA_CHECKING"
    ...
    iget-object v5, v0, Lcom/android/server/MountService;->mUmsEnablingVolumes:Ljava/util/ArrayList;
    ...
    iget-object v4, v0, Lcom/android/server/MountService;->mUmsEnablingVolumes:Ljava/util/ArrayList;
    ...
    const-string v7, "mUmsEnablingVolumes.remove"
    ...
    const-string v6, "mUmsEnablingVolumes.isEmpty, notifying"
    ...
    invoke-direct {v0, v4}, Lcom/android/server/MountService;->setUmsEnabling(Z)V
...
.method private readStorageListLocked()V
    ...
    iput v0, v1, Lcom/android/server/MountService;->storageindex:I
...
.method private upAdd(Landroid/os/storage/ExtraInfo;Ljava/util/LinkedList;)V
    .locals 5
    .parameter "element"
    .parameter
    .annotation system Ldalvik/annotation/Signature;
    ...
    .prologue
    .local p2, elemList:Ljava/util/LinkedList;,"Ljava/util/LinkedList<Landroid/os/storage/ExtraInfo;>;"
    iget-object v4, p1, Landroid/os/storage/ExtraInfo;->mName:Ljava/lang/String;
    ...
    check-cast v0, Landroid/os/storage/ExtraInfo;

    .local v0, e:Landroid/os/storage/ExtraInfo;
    iget-object v2, v0, Landroid/os/storage/ExtraInfo;->mName:Ljava/lang/String;
    ...
    .end local v0           #e:Landroid/os/storage/ExtraInfo;
...
.method public getAllExtraInfos()Ljava/util/List;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .local v5, ret:Ljava/util/LinkedList;,"Ljava/util/LinkedList<Landroid/os/storage/ExtraInfo;>;"
    iget-object v7, p0, Lcom/android/server/MountService;->mExtraInfos:Ljava/util/HashMap;
    ...
    const-string v8, "===getAllExtraInfos start==="

    invoke-static {v6, v8}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    const/4 v6, 0x0

    iput v6, p0, Lcom/android/server/MountService;->mNoUuidExternalStorageCount:I

    iget-object v6, p0, Lcom/android/server/MountService;->mExtraInfos:Ljava/util/HashMap;
    ...
    check-cast v3, Lcom/android/server/MountService$ExtraInfoInternal;

    .local v3, mntInfo:Lcom/android/server/MountService$ExtraInfoInternal;
    invoke-interface {v0}, Ljava/util/Map$Entry;->getKey()Ljava/lang/Object;
    ...
    new-instance v2, Landroid/os/storage/ExtraInfo;

    invoke-direct {v2}, Landroid/os/storage/ExtraInfo;-><init>()V

    .local v2, mem:Landroid/os/storage/ExtraInfo;
    iput-object v4, v2, Landroid/os/storage/ExtraInfo;->mMountPoint:Ljava/lang/String;

    iget-object v6, v3, Lcom/android/server/MountService$ExtraInfoInternal;->mUUID:Ljava/lang/String;

    iput-object v6, v2, Landroid/os/storage/ExtraInfo;->mUUID:Ljava/lang/String;

    iget-object v6, v3, Lcom/android/server/MountService$ExtraInfoInternal;->mDevType:Ljava/lang/String;

    iput-object v6, v2, Landroid/os/storage/ExtraInfo;->mDevType:Ljava/lang/String;

    iget v6, v3, Lcom/android/server/MountService$ExtraInfoInternal;->mDevNode:I

    iput v6, v2, Landroid/os/storage/ExtraInfo;->mDevNode:I

    const-string v6, "SDCARD"

    iget-object v8, v2, Landroid/os/storage/ExtraInfo;->mDevType:Ljava/lang/String;
    ...
    iget-object v6, p0, Lcom/android/server/MountService;->mUuidInternalStorageName:Ljava/lang/String;

    iput-object v6, v2, Landroid/os/storage/ExtraInfo;->mName:Ljava/lang/String;
    ...
    const-string v9, "===getAllExtraInfos==="

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, v2, Landroid/os/storage/ExtraInfo;->mMountPoint:Ljava/lang/String;
    ...
    iget-object v9, v2, Landroid/os/storage/ExtraInfo;->mUUID:Ljava/lang/String;
    ...
    iget-object v9, v2, Landroid/os/storage/ExtraInfo;->mDevType:Ljava/lang/String;
    ...
    iget v9, v2, Landroid/os/storage/ExtraInfo;->mDevNode:I
    ...
    iget-object v9, v2, Landroid/os/storage/ExtraInfo;->mName:Ljava/lang/String;
    ...
    iget v9, v2, Landroid/os/storage/ExtraInfo;->mDevFs:I
    ...
    invoke-direct {p0, v2, v5}, Lcom/android/server/MountService;->upAdd(Landroid/os/storage/ExtraInfo;Ljava/util/LinkedList;)V

    goto/16 :goto_0

    .end local v0           #entry:Ljava/util/Map$Entry;
    .end local v1           #iter:Ljava/util/Iterator;
    .end local v2           #mem:Landroid/os/storage/ExtraInfo;
    .end local v3           #mntInfo:Lcom/android/server/MountService$ExtraInfoInternal;
    ...
    .restart local v2       #mem:Landroid/os/storage/ExtraInfo;
    .restart local v3       #mntInfo:Lcom/android/server/MountService$ExtraInfoInternal;
    .restart local v4       #mountPoint:Ljava/lang/String;
    :cond_0
    :try_start_1
    iget-object v6, v2, Landroid/os/storage/ExtraInfo;->mUUID:Ljava/lang/String;

    invoke-direct {p0, v6}, Lcom/android/server/MountService;->getName(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    iput-object v6, v2, Landroid/os/storage/ExtraInfo;->mName:Ljava/lang/String;

    iget v6, v3, Lcom/android/server/MountService$ExtraInfoInternal;->mDevFs:I

    iput v6, v2, Landroid/os/storage/ExtraInfo;->mDevFs:I
...
.method public onEvent(ILjava/lang/String;[Ljava/lang/String;)Z
    ...
    .local v18, devNode:I
    new-instance v22, Lcom/android/server/MountService$ExtraInfoInternal;

    move-object/from16 v0, v22

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/android/server/MountService$ExtraInfoInternal;-><init>(Lcom/android/server/MountService;)V

    .local v22, extraInfo:Lcom/android/server/MountService$ExtraInfoInternal;
    const/4 v3, 0x3
    ...
    iput v0, v1, Lcom/android/server/MountService$ExtraInfoInternal;->mDevNode:I

    move-object/from16 v0, p0

    move/from16 v1, v20

    invoke-virtual {v0, v1}, Lcom/android/server/MountService;->volumeTypeToString(I)Ljava/lang/String;

    move-result-object v3

    move-object/from16 v0, v22

    iput-object v3, v0, Lcom/android/server/MountService$ExtraInfoInternal;->mDevType:Ljava/lang/String;
    ...
    iput-object v3, v0, Lcom/android/server/MountService$ExtraInfoInternal;->mUUID:Ljava/lang/String;

    const/16 v3, 0x12

    aget-object v17, p3, v3

    .local v17, devFs:Ljava/lang/String;
    if-eqz v17, :cond_1
    ...
    iput v3, v0, Lcom/android/server/MountService$ExtraInfoInternal;->mDevFs:I
    ...
    iget-object v3, v0, Lcom/android/server/MountService;->mExtraInfos:Ljava/util/HashMap;
    ...
    .end local v17           #devFs:Ljava/lang/String;
    .end local v18           #devNode:I
    .end local v20           #devType:I
    .end local v22           #extraInfo:Lcom/android/server/MountService$ExtraInfoInternal;
    ...
    .restart local v17       #devFs:Ljava/lang/String;
    .restart local v18       #devNode:I
    .restart local v20       #devType:I
    .restart local v22       #extraInfo:Lcom/android/server/MountService$ExtraInfoInternal;
    ...
    .local v16, devComp:Ljava/lang/String;
    const-string v3, ":"
    ...
    .local v19, devTok:[Ljava/lang/String;
    const/4 v3, 0x0
    ...
    .end local v16           #devComp:Ljava/lang/String;
    .end local v19           #devTok:[Ljava/lang/String;
    :goto_3
    move-object/from16 v0, p0
    ...
    new-instance v3, Lcom/android/server/MountService$4;

    move-object/from16 v0, p0

    move-object/from16 v1, v28

    invoke-direct {v3, v0, v1}, Lcom/android/server/MountService$4;-><init>(Lcom/android/server/MountService;Ljava/lang/String;)V

    invoke-virtual {v3}, Lcom/android/server/MountService$4;->start()V
    ...
    iget-object v3, v0, Lcom/android/server/MountService;->mVolumeMap:Ljava/util/HashMap;
    ...
    invoke-direct {v0, v3}, Lcom/android/server/MountService;->deleteOldVolume(Landroid/os/storage/StorageVolume;)V
    ...
    .end local v26           #major:I
    .end local v27           #minor:I
    .end local v28           #path:Ljava/lang/String;
    .end local v29           #state:Ljava/lang/String;
    .end local v31           #volume:Landroid/os/storage/StorageVolume;
    :cond_c
...
.method public setUsbMassStorageEnabled(Z)V
    ...
    const-string v12, "setUsbMassStorageEnabled "
    ...
    :cond_1
    iget-object v11, p0, Lcom/android/server/MountService;->mUmsEnablingVolumes:Ljava/util/ArrayList;
    ...
    const-string v12, "mUmsEnablingVolumes.clear"
    ...
    iget-object v10, p0, Lcom/android/server/MountService;->mSharedVolumes:Ljava/util/ArrayList;
    ...
    const-string v13, "mUmsEnablingVolumes.add "
    ...
    .end local v5           #paths:[Ljava/lang/String;
    .end local v7           #states:[Ljava/lang/String;
    .end local v9           #vs:Ljava/lang/String;
    :catchall_1
    move-exception v10
    ...
    .restart local v5       #paths:[Ljava/lang/String;
    .restart local v7       #states:[Ljava/lang/String;
    .restart local v9       #vs:Ljava/lang/String;
    :catchall_2
    move-exception v10
    ...
    sget-object v10, Lcom/android/server/MountService;->EXTERNAL_STORAGE_PATH:Ljava/lang/String;
    ...
    invoke-direct {v8, p0, v4, v10, v11}, Lcom/android/server/MountService$UmsEnableCallBack;-><init>(Lcom/android/server/MountService;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, v4, v10, p1}, Lcom/android/server/MountService;->doShareUnshareVolume(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    .restart local v8       #umscb:Lcom/android/server/MountService$UmsEnableCallBack;
    iget-object v10, p0, Lcom/android/server/MountService;->mHandler:Landroid/os/Handler;
...
.method volumeTypeToString(I)Ljava/lang/String;
    .locals 1
    .parameter "type"
