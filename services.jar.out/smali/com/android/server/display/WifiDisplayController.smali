...
.field private static final RTSP_TIMEOUT_SECONDS:I = 0x3c
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/display/WifiDisplayController$Listener;)V
    ...
    iput-object v6, p0, Lcom/android/server/display/WifiDisplayController;->mAddrObserver:Landroid/os/FileObserver;

    new-instance v3, Ljava/io/File;

    const-string v4, "/data/misc/adb"

    invoke-direct {v3, v4}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    iput-object v3, p0, Lcom/android/server/display/WifiDisplayController;->mFolder:Ljava/io/File;

    iput-boolean v7, p0, Lcom/android/server/display/WifiDisplayController;->mAutoStartWfd:Z
    ...
    iget-object v4, p0, Lcom/android/server/display/WifiDisplayController;->mFolder:Ljava/io/File;
    ...
    invoke-direct {v3, p0, v4, v5}, Lcom/android/server/display/WifiDisplayController$1;-><init>(Lcom/android/server/display/WifiDisplayController;Ljava/lang/String;I)V

    iput-object v3, p0, Lcom/android/server/display/WifiDisplayController;->mAddrObserver:Landroid/os/FileObserver;

    iget-object v3, p0, Lcom/android/server/display/WifiDisplayController;->mAddrObserver:Landroid/os/FileObserver;
    ...
    const-string v3, "android.net.dnsmasq.IP_ADDR"
    ...
    invoke-direct {v2, p0, v3}, Lcom/android/server/display/WifiDisplayController$2;-><init>(Lcom/android/server/display/WifiDisplayController;Landroid/os/Handler;)V
...
.method static synthetic access$000(Lcom/android/server/display/WifiDisplayController;)Ljava/io/File;
    .locals 1
    .parameter "x0"

    .prologue
    iget-object v0, p0, Lcom/android/server/display/WifiDisplayController;->mFolder:Ljava/io/File;
...
.method static synthetic access$100(Lcom/android/server/display/WifiDisplayController;)Z
    ...
    .prologue
    iget-boolean v0, p0, Lcom/android/server/display/WifiDisplayController;->mAutoStartWfd:Z
...
.method static synthetic access$102(Lcom/android/server/display/WifiDisplayController;Z)Z
    ...
    .prologue
    iput-boolean p1, p0, Lcom/android/server/display/WifiDisplayController;->mAutoStartWfd:Z
...
.method static synthetic access$200(Lcom/android/server/display/WifiDisplayController;Ljava/lang/String;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"

    .prologue
    invoke-direct {p0, p1}, Lcom/android/server/display/WifiDisplayController;->parseDnsmasqAddr(Ljava/lang/String;)V
...
.method static synthetic access$3100(Lcom/android/server/display/WifiDisplayController;)I
    ...
    .prologue
    iget v0, p0, Lcom/android/server/display/WifiDisplayController;->mWfdPort:I

    return v0
.end method

.method static synthetic access$3102(Lcom/android/server/display/WifiDisplayController;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"

    .prologue
    iput p1, p0, Lcom/android/server/display/WifiDisplayController;->mWfdPort:I

    return p1
.end method

.method static synthetic access$3200(Lcom/android/server/display/WifiDisplayController;)Landroid/net/wifi/p2p/WifiP2pInfo;
    .locals 1
    .parameter "x0"

    .prologue
    iget-object v0, p0, Lcom/android/server/display/WifiDisplayController;->mP2pInfo:Landroid/net/wifi/p2p/WifiP2pInfo;

    return-object v0
.end method

.method static synthetic access$3202(Lcom/android/server/display/WifiDisplayController;Landroid/net/wifi/p2p/WifiP2pInfo;)Landroid/net/wifi/p2p/WifiP2pInfo;
    .locals 0
    .parameter "x0"
    .parameter "x1"

    .prologue
    iput-object p1, p0, Lcom/android/server/display/WifiDisplayController;->mP2pInfo:Landroid/net/wifi/p2p/WifiP2pInfo;

    return-object p1
.end method

.method static synthetic access$3300(Lcom/android/server/display/WifiDisplayController;Ljava/lang/String;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
    ...
    .prologue
    invoke-direct {p0, p1, p2}, Lcom/android/server/display/WifiDisplayController;->connectToRtspServer(Ljava/lang/String;I)V
...
.method private advertiseDisplay(Landroid/hardware/display/WifiDisplay;Landroid/view/Surface;III)V
    ...
    invoke-direct/range {v0 .. v8}, Lcom/android/server/display/WifiDisplayController$18;-><init>(Lcom/android/server/display/WifiDisplayController;Landroid/view/Surface;Landroid/view/Surface;Landroid/hardware/display/WifiDisplay;Landroid/hardware/display/WifiDisplay;III)V
...
.method private connectToRtspServer(Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, v1, p1, v0}, Lcom/android/server/display/WifiDisplayController;->sendDnsmasqBroadcast(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private handleConnectionChanged(Landroid/net/NetworkInfo;)V
    ...
    invoke-direct {v2, p0}, Lcom/android/server/display/WifiDisplayController$14;-><init>(Lcom/android/server/display/WifiDisplayController;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/display/WifiDisplayController;->mAutoStartWfd:Z
...
.method private parseDnsmasqAddr(Ljava/lang/String;)V
    ...
    iget v6, p0, Lcom/android/server/display/WifiDisplayController;->mWfdPort:I

    invoke-direct {p0, v2, v6}, Lcom/android/server/display/WifiDisplayController;->connectToRtspServer(Ljava/lang/String;I)V
...
.method public sendDnsmasqBroadcast(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 4
    .parameter "mac"
    .parameter "ip"
    .parameter "port"
