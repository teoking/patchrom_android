...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/INetworkPolicyManager;Lcom/android/server/ConnectivityService$NetworkFactory;)V
    ...
    const-string v4, "mNetworkPreference"
    ...
    iget v4, v0, Lcom/android/server/ConnectivityService;->mNetworkPreference:I
    ...
    const-string v4, "NetworkAttributes naString: "
    ...
    check-cast v0, Landroid/net/ethernet/EthernetStateTracker;
    ...
    .local v30, pppoetracker:Landroid/net/NetworkStateTracker;
    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/server/ConnectivityService;->mNetTrackers:[Landroid/net/NetworkStateTracker;

    aput-object v30, v2, v35

    new-instance v29, Lcom/android/server/PppoeService;

    move-object/from16 v0, v30

    check-cast v0, Landroid/net/pppoe/PppoeStateTracker;
    ...
    .local v29, pppoe:Lcom/android/server/PppoeService;
    ...
    .end local v29           #pppoe:Lcom/android/server/PppoeService;
    .end local v30           #pppoetracker:Landroid/net/NetworkStateTracker;
    :cond_15
    move-object/from16 v0, p0
...
.method private handleConnect(Landroid/net/NetworkInfo;)V
    ...
    const-string v8, "handleConnect: ActiveDefaultNetwork is "
    ...
    const-string v6, "net.pppoe.phyif"
    ...
    const-string v7, "PPPoE/Ether Connected, DO NOT teardown ETHERNET"

    invoke-static {v6, v7}, Landroid/util/Slog;->v(Ljava/lang/String;Ljava/lang/String;)I

    .end local v2           #otherNet:Landroid/net/NetworkStateTracker;
    .end local v3           #otherNetInfo:Landroid/net/NetworkInfo;
    :cond_0
    :goto_0
    monitor-enter p0
    ...
    invoke-direct {p0, v1, v11}, Lcom/android/server/ConnectivityService;->handleConnectivityChange(IZ)V
    ...
    invoke-interface {v6, v4, v1}, Lcom/android/internal/app/IBatteryStats;->noteNetworkInterfaceType(Ljava/lang/String;I)V
    :try_end_1
    ...
    .restart local v3       #otherNetInfo:Landroid/net/NetworkInfo;
    :cond_4
    if-ne v1, v10, :cond_5
    ...
    const-string v7, "Ethernet is connected, DO NOT teardown PPPoE"

    invoke-static {v6, v7}, Landroid/util/Slog;->v(Ljava/lang/String;Ljava/lang/String;)I

    const-string v6, "ConnectivityService"

    const-string v7, "PPPoE is prior to Ethernet, DO NOT add dns and route about Ethernet"

    invoke-static {v6, v7}, Landroid/util/Slog;->v(Ljava/lang/String;Ljava/lang/String;)I

    invoke-interface {v5, v12}, Landroid/net/NetworkStateTracker;->setTeardownRequested(Z)V
    ...
    const-string v7, "PPPoE/Wifi Connected, DO NOT teardown PPPoE"
    ...
    const-string v7, "PPPoE/Ethernet Connected, DO NOT teardown PPPoE"
...
.method public sendMessage(ILandroid/net/NetworkInfo;)V
    ...
    invoke-virtual {v1, p1, p2}, Lcom/android/server/ConnectivityService$InternalHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
