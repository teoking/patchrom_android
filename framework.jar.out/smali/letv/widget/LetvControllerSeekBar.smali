.class public Lletv/widget/LetvControllerSeekBar;
.super Landroid/widget/SeekBar;
.source "LetvControllerSeekBar.java"
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, Lletv/widget/LetvControllerSeekBar;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lletv/widget/LetvControllerSeekBar;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method protected declared-synchronized onDraw(Landroid/graphics/Canvas;)V
    ...
    :try_start_0
    invoke-virtual {p0}, Lletv/widget/LetvControllerSeekBar;->getProgress()I

    move-result v4

    .local v4, progress:I
    invoke-virtual {p0}, Lletv/widget/LetvControllerSeekBar;->getSecondaryProgress()I

    move-result v6

    .local v6, sendcondProgress:I
    invoke-virtual {p0}, Lletv/widget/LetvControllerSeekBar;->getProgressDrawable()Landroid/graphics/drawable/Drawable;
    ...
    .local v3, n:F
    invoke-virtual {p0}, Lletv/widget/LetvControllerSeekBar;->getWidth()I

    move-result v7

    invoke-virtual {p0}, Lletv/widget/LetvControllerSeekBar;->getPaddingLeft()I

    move-result v8

    sub-int/2addr v7, v8

    invoke-virtual {p0}, Lletv/widget/LetvControllerSeekBar;->getPaddingRight()I
    ...
    invoke-virtual {p0}, Lletv/widget/LetvControllerSeekBar;->getMax()I
