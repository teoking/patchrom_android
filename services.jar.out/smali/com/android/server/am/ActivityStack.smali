...
.field static PutClassName:Ljava/lang/String; = null
...
.field static mobileApkSpecialProcess:Z = false
...
# instance fields
.field private FreescaleLocked:Ljava/lang/Object;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/am/ActivityStack;->mobileApkSpecialProcess:Z
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/content/Context;Z)V
    ...
    iput-object v1, p0, Lcom/android/server/am/ActivityStack;->FreescaleLocked:Ljava/lang/Object;
...
.method static synthetic access$000(Lcom/android/server/am/ActivityStack;)Ljava/lang/Object;
    .locals 1
    .parameter "x0"

    .prologue
    iget-object v0, p0, Lcom/android/server/am/ActivityStack;->FreescaleLocked:Ljava/lang/Object;
...
.method private final completeResumeLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    :goto_0
    const-string v3, "ro.app.optimization"
    ...
    invoke-direct {p0}, Lcom/android/server/am/ActivityStack;->getRunPkgName()[Ljava/lang/String;

    move-result-object v2

    .local v2, runPkgName:[Ljava/lang/String;
    invoke-direct {p0, p1, v2}, Lcom/android/server/am/ActivityStack;->nativeOptimization(Lcom/android/server/am/ActivityRecord;[Ljava/lang/String;)I
    ...
    invoke-virtual {v3}, Lcom/android/server/am/ActivityManagerService;->killAllBackgroundProcesses()V

    .end local v1           #ret:I
    .end local v2           #runPkgName:[Ljava/lang/String;
    :cond_2
    return-void
...
.method private getRunPkgName()[Ljava/lang/String;
    .locals 9
    ...
    .local v4, mActivityMgr:Landroid/app/ActivityManager;
    const/16 v7, 0x400
    ...
    .local v5, runPkgName:[Ljava/lang/String;
    if-eq v0, v6, :cond_1
    ...
    .end local v5           #runPkgName:[Ljava/lang/String;
    :cond_0
    move v0, v6
    ...
    .restart local v5       #runPkgName:[Ljava/lang/String;
    :cond_1
    return-object v5
.end method

.method private final hideRotBtnBroadcast()V
    .locals 4

    .prologue
    iget-object v2, p0, Lcom/android/server/am/ActivityStack;->mService:Lcom/android/server/am/ActivityManagerService;

    iget-object v0, v2, Lcom/android/server/am/ActivityManagerService;->mContext:Landroid/content/Context;
    ...
    const-string v2, "android.intent.action.RECORD_ROTATION_SHOW"

    invoke-direct {v1, v2}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .local v1, rotIntent:Landroid/content/Intent;
    const-string v2, "rot_setting"
    ...
    .end local v1           #rotIntent:Landroid/content/Intent;
    :cond_0
    return-void
.end method
...
.method private killBackgroundProcess()V
    ...
    .end local v1           #apinfo:Landroid/app/ActivityManager$RunningAppProcessInfo;
    .end local v2           #i:I
...
.method private native nativeOptimization(Lcom/android/server/am/ActivityRecord;[Ljava/lang/String;)I
.end method
...
.method native disableFreeScaleMBX()I
.end method
...
.method native enableFreeScaleMBX()I
.end method
...
.method public getTaskAccessInfoLocked(IZ)Lcom/android/server/am/TaskAccessInfo;
    ...
    new-instance v7, Lcom/android/server/am/ActivityStack$6;

    invoke-direct {v7, p0, v6}, Lcom/android/server/am/ActivityStack$6;-><init>(Lcom/android/server/am/ActivityStack;Lcom/android/server/am/TaskAccessInfo;)V
...
.method public native nativeOptimization(Lcom/android/server/am/ActivityRecord;Ljava/lang/String;[Ljava/lang/String;)I
.end method
...
.method final readXml(Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;)Z
    .locals 22
    .parameter "mContext"
    .parameter "file"
    .parameter "classname"
    ...
    .local v19, xrp:Landroid/content/res/XmlResourceParser;
    ...
    .local v11, listclass:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    invoke-virtual {v13}, Ljava/util/HashMap;->clear()V

    const/4 v3, 0x0

    .local v3, XmlPackageName:Ljava/lang/String;
    const/4 v2, 0x0

    .local v2, XmlClassName:Ljava/lang/String;
    const/4 v4, 0x0

    .local v4, backValue:Z
    move-object v12, v11

    .end local v11           #listclass:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    .local v12, listclass:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    :goto_0
    :try_start_0
    ...
    const-string v20, "FilterActivity"
    ...
    invoke-interface/range {v19 .. v19}, Landroid/content/res/XmlResourceParser;->getAttributeCount()I
    ...
    invoke-interface/range {v19 .. v20}, Landroid/content/res/XmlResourceParser;->getAttributeValue(I)Ljava/lang/String;
    :try_end_0
    ...
    .end local v12           #listclass:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    .end local v14           #name:Ljava/lang/String;
    .restart local v11       #listclass:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    :goto_2
    :try_start_1
    ...
    .end local v11           #listclass:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    .restart local v12       #listclass:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    goto :goto_0
    ...
    .local v18, val:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    ...
    .local v17, typeclass:Ljava/lang/String;
    ...
    .end local v4           #backValue:Z
    .end local v7           #entry:Ljava/util/Map$Entry;
    .end local v8           #i$:Ljava/util/Iterator;
    .end local v9           #iter:Ljava/util/Iterator;
    .end local v10           #key:Ljava/lang/String;
    .end local v17           #typeclass:Ljava/lang/String;
    .end local v18           #val:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    :cond_4
    :goto_5
    return v4

    .end local v11           #listclass:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    .restart local v4       #backValue:Z
    .restart local v12       #listclass:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    :cond_5
    :try_start_3
    invoke-interface/range {v19 .. v19}, Landroid/content/res/XmlResourceParser;->getEventType()I
    ...
    const-string v21, "FilterActivity"
    ...
    .restart local v18       #val:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    :cond_8
    move-object/from16 v0, p4
    ...
    const-string v21, "map not have packagename"
...
.method final resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/am/ActivityStack;->getRunPkgName()[Ljava/lang/String;

    move-result-object v32

    .local v32, runPkgName:[Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/am/ActivityStack;->nativeOptimization(Lcom/android/server/am/ActivityRecord;[Ljava/lang/String;)I
    ...
    .end local v31           #ret:I
    .end local v32           #runPkgName:[Ljava/lang/String;
    :cond_e
    const/16 v34, 0x0
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/am/ActivityStack;->hideRotBtnBroadcast()V
    ...
    .local v29, resumeClassName:Ljava/lang/String;
    move-object/from16 v0, v24
    ...
    .local v30, resumePackageName:Ljava/lang/String;
    sput-object v29, Lcom/android/server/am/ActivityStack;->PutClassName:Ljava/lang/String;
    ...
    const-string v5, "resumeClassName is "
    ...
    const-string v5, "resumePackageName is "
    ...
    .local v27, prevClassName:Ljava/lang/String;
    const-string v3, "ActivityManager"
    ...
    const-string v5, "prevClassName is "
    ...
    .end local v27           #prevClassName:Ljava/lang/String;
    :goto_9
    move-object/from16 v0, p0
    ...
    const-string v3, "media.p2pplay.enable"
    ...
    new-instance v19, Lcom/android/server/am/ActivityStack$2;
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/am/ActivityStack$2;-><init>(Lcom/android/server/am/ActivityStack;Landroid/content/ContentResolver;)V

    .local v19, disrunnable:Ljava/lang/Runnable;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v0, v3, v4, v1, v2}, Lcom/android/server/am/ActivityStack;->readXml(Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;)Z
    ...
    .local v14, DisableFreeScaleThread:Ljava/lang/Thread;
    invoke-virtual {v14}, Ljava/lang/Thread;->start()V
    :try_end_4
    .catch Ljava/lang/Exception; {:try_start_4 .. :try_end_4} :catch_2

    .end local v14           #DisableFreeScaleThread:Ljava/lang/Thread;
    .end local v19           #disrunnable:Ljava/lang/Runnable;
    .end local v28           #resolver:Landroid/content/ContentResolver;
    .end local v29           #resumeClassName:Ljava/lang/String;
    .end local v30           #resumePackageName:Ljava/lang/String;
    :cond_20
    :goto_a
    const/4 v3, 0x0
    ...
    .restart local v29       #resumeClassName:Ljava/lang/String;
    .restart local v30       #resumePackageName:Ljava/lang/String;
    :cond_23
    :try_start_5
    const-string v3, "ActivityManager"

    const-string v4, "prevClassName is null"
    ...
    .end local v20           #e:Ljava/lang/Exception;
    .restart local v19       #disrunnable:Ljava/lang/Runnable;
    .restart local v28       #resolver:Landroid/content/ContentResolver;
    .restart local v29       #resumeClassName:Ljava/lang/String;
    .restart local v30       #resumePackageName:Ljava/lang/String;
    :cond_24
    :try_start_6
    invoke-static/range {v28 .. v29}, Landroid/provider/Settings$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;)I
    ...
    const-string v4, "Setting found the classname in secure table!"
    ...
    .restart local v14       #DisableFreeScaleThread:Ljava/lang/Thread;
    invoke-virtual {v14}, Ljava/lang/Thread;->start()V
    :try_end_6
    ...
    const-string v4, "Setting not found the classname in secure table!"

    invoke-static {v3, v4}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v33, Lcom/android/server/am/ActivityStack$3;
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/am/ActivityStack$3;-><init>(Lcom/android/server/am/ActivityStack;Landroid/content/ContentResolver;)V

    .local v33, runnable:Ljava/lang/Runnable;
    ...
    .local v15, EnableFreeScaleThread:Ljava/lang/Thread;
    invoke-virtual {v15}, Ljava/lang/Thread;->start()V

    goto/16 :goto_a

    .end local v15           #EnableFreeScaleThread:Ljava/lang/Thread;
    .end local v20           #e:Landroid/provider/Settings$SettingNotFoundException;
    .end local v33           #runnable:Ljava/lang/Runnable;
    :cond_25
    const-string v3, "ActivityManager"

    const-string v4, "whitepackagefilter has find classname or packagename in resumeactivity"
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/os/IBinder;Ljava/lang/String;IIIILandroid/os/Bundle;Z[Lcom/android/server/am/ActivityRecord;)I
    ...
    .local v31, mPm:Landroid/content/pm/PackageManager;
    if-eqz p1, :cond_0
    ...
    .local v38, sourceRecord:Lcom/android/server/am/ActivityRecord;
    const/4 v5, 0x0
    ...
    .end local v38           #sourceRecord:Lcom/android/server/am/ActivityRecord;
    check-cast v38, Lcom/android/server/am/ActivityRecord;

    .restart local v38       #sourceRecord:Lcom/android/server/am/ActivityRecord;
    if-ltz p7, :cond_2
    ...
    :goto_5
    sput-object v23, Lcom/android/server/am/ActivityStack;->PutClassName:Ljava/lang/String;
    ...
    const-string v7, "start package name is "
    ...
    .restart local v37       #setClassName:Z
    :cond_d
    const-string v3, "media.p2pplay.enable"
    ...
    new-instance v36, Lcom/android/server/am/ActivityStack$4;
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/am/ActivityStack$4;-><init>(Lcom/android/server/am/ActivityStack;Landroid/content/ContentResolver;)V

    .local v36, runnable:Ljava/lang/Runnable;
    move-object/from16 v0, p0
    ...
    .local v19, DisableFreeScaleThread:Ljava/lang/Thread;
    invoke-virtual/range {v19 .. v19}, Ljava/lang/Thread;->start()V

    .end local v19           #DisableFreeScaleThread:Ljava/lang/Thread;
    .end local v36           #runnable:Ljava/lang/Runnable;
    :cond_e
    :goto_6
    move-object/from16 v0, p0
    ...
    .end local v24           #componentPerm:I
    .end local v32           #msg:Ljava/lang/String;
    .end local v39           #startAnyPerm:I
    .restart local v36       #runnable:Ljava/lang/Runnable;
    :cond_10
    :try_start_0
    ...
    .restart local v19       #DisableFreeScaleThread:Ljava/lang/Thread;
    invoke-virtual/range {v19 .. v19}, Ljava/lang/Thread;->start()V
    :try_end_0
    ...
    const-string v4, "blackpackagefilter  not found packagename or classname"
    ...
    const-string v4, "whitepackagefilter  has packagename or classname"
    ...
    .end local v36           #runnable:Ljava/lang/Runnable;
    .restart local v24       #componentPerm:I
    .restart local v39       #startAnyPerm:I
    :cond_13
    new-instance v3, Ljava/lang/StringBuilder;
    ...
    :try_start_2
    new-instance v36, Lcom/android/server/am/ActivityStack$5;
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/am/ActivityStack$5;-><init>(Lcom/android/server/am/ActivityStack;Landroid/content/ContentResolver;)V
    ...
    .local v20, EnableFreeScaleThread:Ljava/lang/Thread;
    invoke-virtual/range {v20 .. v20}, Ljava/lang/Thread;->start()V
    :try_end_2
    .catch Ljava/lang/NullPointerException; {:try_start_2 .. :try_end_2} :catch_2

    .end local v20           #EnableFreeScaleThread:Ljava/lang/Thread;
    .end local v36           #runnable:Ljava/lang/Runnable;
    :cond_1d
    :goto_b
    move/from16 v3, v26
    ...
    .local v27, err_null:Ljava/lang/NullPointerException;
    const-string v3, "ActivityManager"

    const-string v4, "Settings.Secure.putString get NullPointerException ERROR!!!"

    invoke-static {v3, v4}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    goto :goto_b

    .end local v27           #err_null:Ljava/lang/NullPointerException;
    :cond_1f
    const-string v3, "class_name"
...
.method final startActivityMayWait(Landroid/app/IApplicationThread;ILandroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILjava/lang/String;Landroid/os/ParcelFileDescriptor;Landroid/app/IActivityManager$WaitResult;Landroid/content/res/Configuration;Landroid/os/Bundle;I)I
    ...
    const-string v2, "com.npc.landlord3"
    ...
    const-string v2, "service.apk.resize"
