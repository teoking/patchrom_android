...
.field private mLetvTitleIcon:Landroid/widget/ImageView;
...
.method private installDecor()V
    ...
    invoke-virtual {v11, v13}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->setDescendantFocusability(I)V

    iget-object v11, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mDecor:Lcom/android/internal/policy/impl/PhoneWindow$DecorView;

    invoke-virtual {v11, v9}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->setIsRootNamespace(Z)V

    iget-boolean v11, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mInvalidatePanelMenuPosted:Z

    if-nez v11, :cond_0

    iget v11, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mInvalidatePanelMenuFeatures:I

    if-eqz v11, :cond_0

    iget-object v11, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mDecor:Lcom/android/internal/policy/impl/PhoneWindow$DecorView;

    iget-object v13, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mInvalidatePanelMenuRunnable:Ljava/lang/Runnable;

    invoke-virtual {v11, v13}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->postOnAnimation(Ljava/lang/Runnable;)V
    ...
    iput-object v11, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mLetvTitleIcon:Landroid/widget/ImageView;

    iget-object v11, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mLetvTitleIcon:Landroid/widget/ImageView;
    ...
    invoke-virtual {v6, v11}, Landroid/content/pm/PackageManager;->getActivityIcon(Landroid/content/ComponentName;)Landroid/graphics/drawable/Drawable;
    :try_end_0
    ...
    invoke-virtual {v11, v6}, Landroid/content/pm/ApplicationInfo;->loadLogo(Landroid/content/pm/PackageManager;)Landroid/graphics/drawable/Drawable;
    ...
    const-string v12, "Activity component name not found!"
    ...
    .local v10, titleContainer:Landroid/view/View;
    if-eqz v10, :cond_4
    ...
    .end local v10           #titleContainer:Landroid/view/View;
    :cond_5
    iget-object v11, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mTitleView:Landroid/widget/TextView;
    ...
    invoke-virtual {v11, v13}, Lcom/android/internal/widget/ActionBarView;->setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    iget-object v13, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mTitle:Ljava/lang/CharSequence;

    invoke-virtual {v11, v13}, Lcom/android/internal/widget/ActionBarView;->setWindowTitle(Ljava/lang/CharSequence;)V
    ...
    check-cast v8, Lcom/android/internal/widget/ActionBarContainer;

    .local v8, splitView:Lcom/android/internal/widget/ActionBarContainer;
    if-eqz v8, :cond_d

    iget-object v11, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mActionBar:Lcom/android/internal/widget/ActionBarView;

    invoke-virtual {v11, v8}, Lcom/android/internal/widget/ActionBarView;->setSplitView(Lcom/android/internal/widget/ActionBarContainer;)V

    iget-object v11, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mActionBar:Lcom/android/internal/widget/ActionBarView;

    invoke-virtual {v11, v7}, Lcom/android/internal/widget/ActionBarView;->setSplitActionBar(Z)V

    iget-object v11, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mActionBar:Lcom/android/internal/widget/ActionBarView;

    invoke-virtual {v11, v9}, Lcom/android/internal/widget/ActionBarView;->setSplitWhenNarrow(Z)V
    ...
    invoke-virtual {v1, v8}, Lcom/android/internal/widget/ActionBarContextView;->setSplitView(Lcom/android/internal/widget/ActionBarContainer;)V

    invoke-virtual {v1, v7}, Lcom/android/internal/widget/ActionBarContextView;->setSplitActionBar(Z)V

    invoke-virtual {v1, v9}, Lcom/android/internal/widget/ActionBarContextView;->setSplitWhenNarrow(Z)V
    ...
    new-instance v12, Lcom/android/internal/policy/impl/PhoneWindow$2;

    invoke-direct {v12, p0}, Lcom/android/internal/policy/impl/PhoneWindow$2;-><init>(Lcom/android/internal/policy/impl/PhoneWindow;)V

    invoke-virtual {v11, v12}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->post(Ljava/lang/Runnable;)Z

    goto/16 :goto_1

    .end local v8           #splitView:Lcom/android/internal/widget/ActionBarContainer;
    .end local v9           #splitWhenNarrow:Z
    :cond_b
    move v9, v12

    goto :goto_3

    .restart local v9       #splitWhenNarrow:Z
    :cond_c
    ...
    invoke-virtual {v11, v13, v12}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v7

    goto :goto_4

    .restart local v8       #splitView:Lcom/android/internal/widget/ActionBarContainer;
    :cond_d
    if-eqz v7, :cond_a
...
.method public final onKeyUpPanel(ILandroid/view/KeyEvent;)V
    ...
    invoke-virtual {p0, v3, v6}, Lcom/android/internal/policy/impl/PhoneWindow;->closePanel(Lcom/android/internal/policy/impl/PhoneWindow$PanelFeatureState;Z)V
    ...
    iput-boolean v5, v3, Lcom/android/internal/policy/impl/PhoneWindow$PanelFeatureState;->isPrepared:Z
...
.method public requestFeature(I)Z
    ...
    invoke-virtual {p0, v4}, Lcom/android/internal/policy/impl/PhoneWindow;->removeFeature(I)V
