...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    const-string v3, "bt.keep_on.enable"
    ...
    const-string v3, "bt mScreenOn"

    invoke-static {v2, v3}, Landroid/util/Log;->v(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v2, p0, Lcom/android/server/BluetoothManagerService$3;->this$0:Lcom/android/server/BluetoothManagerService;

    #setter for: Lcom/android/server/BluetoothManagerService;->mScreenOff:Z
    invoke-static {v2, v6}, Lcom/android/server/BluetoothManagerService;->access$1202(Lcom/android/server/BluetoothManagerService;Z)Z

    iget-object v2, p0, Lcom/android/server/BluetoothManagerService$3;->this$0:Lcom/android/server/BluetoothManagerService;

    #getter for: Lcom/android/server/BluetoothManagerService;->mDelayedHandler:Landroid/os/Handler;
    invoke-static {v2}, Lcom/android/server/BluetoothManagerService;->access$200(Lcom/android/server/BluetoothManagerService;)Landroid/os/Handler;

    move-result-object v2

    iget-object v3, p0, Lcom/android/server/BluetoothManagerService$3;->this$0:Lcom/android/server/BluetoothManagerService;

    #getter for: Lcom/android/server/BluetoothManagerService;->mBTtimer:Ljava/lang/Runnable;
    invoke-static {v3}, Lcom/android/server/BluetoothManagerService;->access$1300(Lcom/android/server/BluetoothManagerService;)Ljava/lang/Runnable;
    ...
    const-string v3, "enable Bluetooth radio for GPS after screen on"

    invoke-static {v2, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v2, p0, Lcom/android/server/BluetoothManagerService$3;->this$0:Lcom/android/server/BluetoothManagerService;

    invoke-virtual {v2}, Lcom/android/server/BluetoothManagerService;->isRadioEnabled()Z
    ...
    invoke-virtual {v2}, Lcom/android/server/BluetoothManagerService;->enableRadio()Z
    ...
    #setter for: Lcom/android/server/BluetoothManagerService;->mScreenOff:Z
    invoke-static {v2, v4}, Lcom/android/server/BluetoothManagerService;->access$1202(Lcom/android/server/BluetoothManagerService;Z)Z
    ...
    invoke-static {v2}, Lcom/android/server/BluetoothManagerService;->access$1400(Lcom/android/server/BluetoothManagerService;)I
    ...
    invoke-static {v2}, Lcom/android/server/BluetoothManagerService;->access$1600(Lcom/android/server/BluetoothManagerService;)Z
    ...
    const-string v4, "enable Bluetooth radio for GPS"
