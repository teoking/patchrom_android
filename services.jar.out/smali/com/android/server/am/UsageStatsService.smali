...
.method public noteResumeComponent(Landroid/content/ComponentName;)V
    ...
    iget-object v12, p0, Lcom/android/server/am/UsageStatsService;->mLastResumedPkg:Ljava/lang/String;
    ...
    invoke-virtual {v6}, Lcom/android/server/am/UsageStatsService$PkgUsageStatsExtended;->updatePause()V
    ...
    iget-object v12, p0, Lcom/android/server/am/UsageStatsService;->mLastResumedComp:Ljava/lang/String;
    ...
    new-instance v6, Lcom/android/server/am/UsageStatsService$PkgUsageStatsExtended;

    .end local v6           #pus:Lcom/android/server/am/UsageStatsService$PkgUsageStatsExtended;
    invoke-direct {v6, p0}, Lcom/android/server/am/UsageStatsService$PkgUsageStatsExtended;-><init>(Lcom/android/server/am/UsageStatsService;)V
    ...
    :goto_2
    invoke-virtual {v6, v12, v10}, Lcom/android/server/am/UsageStatsService$PkgUsageStatsExtended;->updateResume(Ljava/lang/String;Z)V

    if-nez v7, :cond_4

    iget-object v10, p0, Lcom/android/server/am/UsageStatsService;->mLastResumedComp:Ljava/lang/String;

    invoke-virtual {v6, v10}, Lcom/android/server/am/UsageStatsService$PkgUsageStatsExtended;->addLaunchCount(Ljava/lang/String;)V
    ...
    :try_start_1
    invoke-virtual {v5, v3, v10}, Landroid/content/pm/PackageManager;->getPackageInfo(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;

    move-result-object v4

    .local v4, pkinfo:Landroid/content/pm/PackageInfo;
    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10}, Ljava/lang/StringBuilder;-><init>()V

    const-string v12, "msgtype=appstartup&packageName="
    ...
    new-instance v2, Lcom/android/letvmanager/LetvManager;

    iget-object v10, p0, Lcom/android/server/am/UsageStatsService;->mContext:Landroid/content/Context;

    invoke-direct {v2, v10}, Lcom/android/letvmanager/LetvManager;-><init>(Landroid/content/Context;)V

    .local v2, manager:Lcom/android/letvmanager/LetvManager;
    invoke-virtual {v2}, Lcom/android/letvmanager/LetvManager;->isRunReportLog()Z

    move-result v10

    if-nez v10, :cond_5

    invoke-virtual {v2}, Lcom/android/letvmanager/LetvManager;->startReportLog()Z

    :cond_5
    invoke-virtual {v2, v9}, Lcom/android/letvmanager/LetvManager;->onReportLog(Ljava/lang/String;)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_1 .. :try_end_1} :catch_0

    .end local v2           #manager:Lcom/android/letvmanager/LetvManager;
    .end local v4           #pkinfo:Landroid/content/pm/PackageInfo;
    .end local v5           #pm:Landroid/content/pm/PackageManager;
    .end local v9           #str:Ljava/lang/String;
    :cond_6
    :goto_3
    :try_start_2
    iget-object v10, p0, Lcom/android/server/am/UsageStatsService;->mLastResumeTimes:Ljava/util/Map;
    ...
    .end local v3           #pkgName:Ljava/lang/String;
    .end local v6           #pus:Lcom/android/server/am/UsageStatsService$PkgUsageStatsExtended;
    .end local v7           #sameComp:Z
    .end local v8           #samePackage:Z
    :catchall_0
    move-exception v10
    ...
    .restart local v3       #pkgName:Ljava/lang/String;
    .restart local v8       #samePackage:Z
    :cond_8
    const/4 v7, 0x0
