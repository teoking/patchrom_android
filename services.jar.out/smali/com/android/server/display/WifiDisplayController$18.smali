...
.method constructor <init>(Lcom/android/server/display/WifiDisplayController;Landroid/view/Surface;Landroid/view/Surface;Landroid/hardware/display/WifiDisplay;Landroid/hardware/display/WifiDisplay;III)V
    ...
    iput-object p2, p0, Lcom/android/server/display/WifiDisplayController$18;->val$oldSurface:Landroid/view/Surface;

    iput-object p3, p0, Lcom/android/server/display/WifiDisplayController$18;->val$surface:Landroid/view/Surface;

    iput-object p4, p0, Lcom/android/server/display/WifiDisplayController$18;->val$oldDisplay:Landroid/hardware/display/WifiDisplay;

    iput-object p5, p0, Lcom/android/server/display/WifiDisplayController$18;->val$display:Landroid/hardware/display/WifiDisplay;

    iput p6, p0, Lcom/android/server/display/WifiDisplayController$18;->val$width:I

    iput p7, p0, Lcom/android/server/display/WifiDisplayController$18;->val$height:I

    iput p8, p0, Lcom/android/server/display/WifiDisplayController$18;->val$flags:I
...
.method public run()V
    ...
    .prologue
    iget-object v0, p0, Lcom/android/server/display/WifiDisplayController$18;->val$oldSurface:Landroid/view/Surface;

    if-eqz v0, :cond_3

    iget-object v0, p0, Lcom/android/server/display/WifiDisplayController$18;->val$surface:Landroid/view/Surface;

    iget-object v1, p0, Lcom/android/server/display/WifiDisplayController$18;->val$oldSurface:Landroid/view/Surface;
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lcom/android/server/display/WifiDisplayController$18;->val$display:Landroid/hardware/display/WifiDisplay;

    if-eqz v0, :cond_2

    iget-object v0, p0, Lcom/android/server/display/WifiDisplayController$18;->val$display:Landroid/hardware/display/WifiDisplay;

    iget-object v1, p0, Lcom/android/server/display/WifiDisplayController$18;->val$oldDisplay:Landroid/hardware/display/WifiDisplay;
    ...
    iget-object v1, p0, Lcom/android/server/display/WifiDisplayController$18;->val$display:Landroid/hardware/display/WifiDisplay;
    ...
    iget-object v2, p0, Lcom/android/server/display/WifiDisplayController$18;->val$surface:Landroid/view/Surface;

    iget v3, p0, Lcom/android/server/display/WifiDisplayController$18;->val$width:I

    iget v4, p0, Lcom/android/server/display/WifiDisplayController$18;->val$height:I

    iget v5, p0, Lcom/android/server/display/WifiDisplayController$18;->val$flags:I
    ...
    :cond_3
    iget-object v0, p0, Lcom/android/server/display/WifiDisplayController$18;->val$oldDisplay:Landroid/hardware/display/WifiDisplay;
