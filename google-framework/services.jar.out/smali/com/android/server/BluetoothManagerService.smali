...
.field private static final MESSAGE_GET_RX_COUNT:I = 0x190
...
.field private final mBTtimer:Ljava/lang/Runnable;
...
.field private mRadioWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v4, p0, Lcom/android/server/BluetoothManagerService;->mQuietEnable:Z

    new-instance v2, Lcom/android/server/BluetoothManagerService$1;

    invoke-direct {v2, p0}, Lcom/android/server/BluetoothManagerService$1;-><init>(Lcom/android/server/BluetoothManagerService;)V

    iput-object v2, p0, Lcom/android/server/BluetoothManagerService;->mBluetoothCallback:Landroid/bluetooth/IBluetoothCallback;

    new-instance v2, Lcom/android/server/BluetoothManagerService$2;

    invoke-direct {v2, p0}, Lcom/android/server/BluetoothManagerService$2;-><init>(Lcom/android/server/BluetoothManagerService;)V

    iput-object v2, p0, Lcom/android/server/BluetoothManagerService;->mBTtimer:Ljava/lang/Runnable;
    ...
    iput-object v2, p0, Lcom/android/server/BluetoothManagerService;->mReceiver:Landroid/content/BroadcastReceiver;

    new-instance v2, Lcom/android/server/BluetoothManagerService$BluetoothServiceConnection;

    invoke-direct {v2, p0, v5}, Lcom/android/server/BluetoothManagerService$BluetoothServiceConnection;-><init>(Lcom/android/server/BluetoothManagerService;Lcom/android/server/BluetoothManagerService$1;)V
    ...
    iput-object v2, p0, Lcom/android/server/BluetoothManagerService;->mBTShutDown:Ljava/lang/Runnable;
    ...
    iput-object v2, p0, Lcom/android/server/BluetoothManagerService;->mThread:Landroid/os/HandlerThread;
    ...
    invoke-direct {v2, p0, v3}, Lcom/android/server/BluetoothManagerService$BluetoothHandler;-><init>(Lcom/android/server/BluetoothManagerService;Landroid/os/Looper;)V
    ...
    iput-object v5, p0, Lcom/android/server/BluetoothManagerService;->mBluetooth:Landroid/bluetooth/IBluetooth;

    iput-boolean v4, p0, Lcom/android/server/BluetoothManagerService;->mBinding:Z

    iput-boolean v4, p0, Lcom/android/server/BluetoothManagerService;->mUnbinding:Z
    ...
    iput-object v5, p0, Lcom/android/server/BluetoothManagerService;->mAddress:Ljava/lang/String;

    iput-object v5, p0, Lcom/android/server/BluetoothManagerService;->mName:Ljava/lang/String;
    ...
    iput-object v2, p0, Lcom/android/server/BluetoothManagerService;->mDelayedHandler:Landroid/os/Handler;
    ...
    iput-object v2, p0, Lcom/android/server/BluetoothManagerService;->mWakeLock:Landroid/os/PowerManager$WakeLock;

    const-string v2, "BluetoothRadio"

    invoke-virtual {v1, v6, v2}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;

    move-result-object v2

    iput-object v2, p0, Lcom/android/server/BluetoothManagerService;->mRadioWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method static synthetic access$1202(Lcom/android/server/BluetoothManagerService;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"

    .prologue
    iput-boolean p1, p0, Lcom/android/server/BluetoothManagerService;->mScreenOff:Z

    return p1
.end method

.method static synthetic access$1300(Lcom/android/server/BluetoothManagerService;)Ljava/lang/Runnable;
    .locals 1
    .parameter "x0"

    .prologue
    iget-object v0, p0, Lcom/android/server/BluetoothManagerService;->mBTtimer:Ljava/lang/Runnable;
...
.method static synthetic access$200(Lcom/android/server/BluetoothManagerService;)Landroid/os/Handler;
    .locals 1
    .parameter "x0"

    .prologue
    iget-object v0, p0, Lcom/android/server/BluetoothManagerService;->mDelayedHandler:Landroid/os/Handler;
...
.method private bluetoothStateChangeHandler(II)V
    ...
    const-string v5, "bt.keep_on.enable"
    ...
    invoke-virtual {p0}, Lcom/android/server/BluetoothManagerService;->acquire_radioWakeLock()V

    :cond_0
    if-ne p2, v8, :cond_1

    invoke-virtual {p0}, Lcom/android/server/BluetoothManagerService;->release_radioWakeLock()V
    ...
    iget-object v4, p0, Lcom/android/server/BluetoothManagerService;->mDelayedHandler:Landroid/os/Handler;

    iget-object v5, p0, Lcom/android/server/BluetoothManagerService;->mBTShutDown:Ljava/lang/Runnable;

    invoke-virtual {v4, v5}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    invoke-virtual {p0}, Lcom/android/server/BluetoothManagerService;->acquireWakeLock()V
    ...
    iget-object v5, p0, Lcom/android/server/BluetoothManagerService;->mBTtimer:Ljava/lang/Runnable;
...
.method public acquireWakeLock()V
    ...
    const-string v1, "acquireWakeLockk"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Lcom/android/server/BluetoothManagerService;->mWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method public acquire_radioWakeLock()V
    .locals 2

    .prologue
    const-string v0, "BluetoothManagerService"

    const-string v1, "acquireRadioWakeLockk"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Lcom/android/server/BluetoothManagerService;->mRadioWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method public release_radioWakeLock()V
    .locals 2

    .prologue
    const-string v0, "BluetoothManagerService"

    const-string v1, "releaseRadioWakeLock"
