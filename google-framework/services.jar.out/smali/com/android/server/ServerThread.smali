...
.method public run()V
    ...
    .local v146, wm:Lcom/android/server/wm/WindowManagerService;
    const/16 v66, 0x0
    ...
    .local v109, overlayview:Lcom/android/server/OverlayViewService;
    ...
    new-instance v147, Landroid/os/HandlerThread;
    ...
    .local v147, wmHandlerThread:Landroid/os/HandlerThread;
    invoke-virtual/range {v147 .. v147}, Landroid/os/HandlerThread;->start()V

    new-instance v21, Landroid/os/Handler;

    invoke-virtual/range {v147 .. v147}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;
    ...
    new-instance v110, Lcom/android/server/OverlayViewService;
    ...
    .end local v109           #overlayview:Lcom/android/server/OverlayViewService;
    .local v110, overlayview:Lcom/android/server/OverlayViewService;
    :try_start_e
    ...
    new-instance v123, Lcom/android/server/SystemWriteService;

    move-object/from16 v0, v123

    invoke-direct {v0, v5}, Lcom/android/server/SystemWriteService;-><init>(Landroid/content/Context;)V

    .local v123, systemWrite:Lcom/android/server/SystemWriteService;
    ...
    new-instance v94, Lcom/android/server/SystemKeyServices;

    move-object/from16 v0, v94

    invoke-direct {v0, v5}, Lcom/android/server/SystemKeyServices;-><init>(Landroid/content/Context;)V

    .local v94, keyServices:Lcom/android/server/SystemKeyServices;
    invoke-virtual/range {v94 .. v94}, Lcom/android/server/SystemKeyServices;->registerSystemKeyReceiver()V
    ...
    invoke-virtual/range {v146 .. v146}, Lcom/android/server/wm/WindowManagerService;->getInputMonitor()Lcom/android/server/wm/InputMonitor;
    ...
    :try_end_10
    .catch Landroid/os/RemoteException; {:try_start_10 .. :try_end_10} :catch_59
    ...
    .end local v110           #overlayview:Lcom/android/server/OverlayViewService;
    .restart local v109       #overlayview:Lcom/android/server/OverlayViewService;
    ...
    .end local v88           #hasBluetooth:Z
    .end local v93           #installer:Lcom/android/server/pm/Installer;
    .end local v94           #keyServices:Lcom/android/server/SystemKeyServices;
    .end local v123           #systemWrite:Lcom/android/server/SystemWriteService;
    ...
    invoke-static {v7, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_13
    .catch Ljava/lang/Throwable; {:try_start_13 .. :try_end_13} :catch_4d
    ...
    :goto_e
    :try_start_15
    invoke-virtual/range {v146 .. v146}, Lcom/android/server/wm/WindowManagerService;->displayReady()V
    :try_end_15
    ...
    :try_end_17
    .catch Landroid/os/RemoteException; {:try_start_17 .. :try_end_17} :catch_4c
    ...
    new-instance v145, Landroid/net/wifi/p2p/WifiP2pService;
    ...
    invoke-virtual/range {v144 .. v144}, Landroid/net/wifi/p2p/WifiP2pService;->connectivityServiceReady()V
    :try_end_2d
    ...
    invoke-static {v7, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_30
    .catch Ljava/lang/Throwable; {:try_start_30 .. :try_end_30} :catch_41
    ...
    invoke-static {v7, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_43
    .catch Ljava/lang/Throwable; {:try_start_43 .. :try_end_43} :catch_3c
    ...
    invoke-static {v7, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_4a
    .catch Ljava/lang/Throwable; {:try_start_4a .. :try_end_4a} :catch_3a
    ...
    invoke-static {v7, v0}, Landroid/os/ServiceManager;->addService(Ljava/lang/String;Landroid/os/IBinder;)V
    :try_end_53
    .catch Ljava/lang/Throwable; {:try_start_53 .. :try_end_53} :catch_38
    ...
    :cond_a
    :goto_39
    invoke-virtual/range {v146 .. v146}, Lcom/android/server/wm/WindowManagerService;->detectSafeMode()Z
    ...
    :goto_3e
    :try_start_58
    invoke-virtual/range {v146 .. v146}, Lcom/android/server/wm/WindowManagerService;->systemReady()V
    :try_end_58
    ...
    :cond_d
    invoke-virtual/range {v146 .. v146}, Lcom/android/server/wm/WindowManagerService;->computeNewConfiguration()Landroid/content/res/Configuration;
    ...
    .end local v142           #wifi:Lcom/android/server/WifiService;
    .end local v144           #wifiP2p:Landroid/net/wifi/p2p/WifiP2pService;
    .end local v146           #wm:Lcom/android/server/wm/WindowManagerService;
    .end local v147           #wmHandlerThread:Landroid/os/HandlerThread;
    :cond_f
    const/16 v114, 0x0
    ...
    .restart local v142       #wifi:Lcom/android/server/WifiService;
    .restart local v144       #wifiP2p:Landroid/net/wifi/p2p/WifiP2pService;
    .restart local v146       #wm:Lcom/android/server/wm/WindowManagerService;
    .restart local v147       #wmHandlerThread:Landroid/os/HandlerThread;
    :cond_12
    :try_start_5c
    const-string v7, "1"
    ...
    .restart local v15       #alarm:Lcom/android/server/AlarmManagerService;
    .restart local v19       #inputManager:Lcom/android/server/input/InputManagerService;
    .restart local v94       #keyServices:Lcom/android/server/SystemKeyServices;
    .restart local v110       #overlayview:Lcom/android/server/OverlayViewService;
    .restart local v123       #systemWrite:Lcom/android/server/SystemWriteService;
    ...
    .restart local v88       #hasBluetooth:Z
    :cond_17
    const/4 v7, 0x1
