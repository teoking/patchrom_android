...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/webkit/WebViewClassic$AnimationUpdateTask;,
        ...
        Landroid/webkit/WebViewClassic$LetvDefaultJavaScript;,
...
.field static final SEND_AUTO_PLAY_YOUKU:I = 0x9a
...
.field private mPrev_Orientation:I
...
.field private mshouldaddLetvJS:Z

.field private mshouldmoveTotop:Z
...
.method public constructor <init>(Landroid/webkit/WebView;Landroid/webkit/WebView$PrivateAccess;)V
    ...
    iput v1, p0, Landroid/webkit/WebViewClassic;->mPrev_Orientation:I
    ...
    iput-boolean v3, p0, Landroid/webkit/WebViewClassic;->mshouldmoveTotop:Z

    iput-boolean v4, p0, Landroid/webkit/WebViewClassic;->mshouldaddLetvJS:Z
...
.method static synthetic access$7100(Landroid/webkit/WebViewClassic;)V
    ...
    .prologue
    invoke-direct {p0}, Landroid/webkit/WebViewClassic;->autoPlayYouku()V
...
.method private autoPlayYouku()V
    .locals 9

    .prologue
    new-instance v4, Lcom/android/letvmanager/LetvManager;

    iget-object v6, p0, Landroid/webkit/WebViewClassic;->mContext:Landroid/content/Context;

    invoke-direct {v4, v6}, Lcom/android/letvmanager/LetvManager;-><init>(Landroid/content/Context;)V

    .local v4, letvManager:Lcom/android/letvmanager/LetvManager;
    ...
    .local v3, iwindowManager:Landroid/view/IWindowManager;
    iget-object v6, p0, Landroid/webkit/WebViewClassic;->mContext:Landroid/content/Context;
    ...
    .local v5, windowManager1:Landroid/view/WindowManager;
    ...
    invoke-interface {v3, v6, v7}, Landroid/view/IWindowManager;->setMousePos(FF)V
    ...
    invoke-virtual {v4, v6, v7, v8}, Lcom/android/letvmanager/LetvManager;->mouseMoveTimes(III)Z

    invoke-virtual {v4}, Lcom/android/letvmanager/LetvManager;->mouseLeftClick()Z
    :try_end_0
...
.method private drawContent(Landroid/graphics/Canvas;)V
    ...
    .local v8, UIAnimationsRunning:Z
    iget v0, p0, Landroid/webkit/WebViewClassic;->mNativeClass:I
    ...
    invoke-direct/range {v0 .. v7}, Landroid/webkit/WebViewClassic;->nativeCreateDrawGLFunction(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/RectF;FII)I
    ...
    invoke-virtual {v0, v12}, Landroid/view/HardwareCanvas;->callDrawGLFunction(I)I
    ...
    .end local v8           #UIAnimationsRunning:Z
    .end local v9           #animateScroll:Z
    ...
    .restart local v9       #animateScroll:Z
    ...
    .restart local v8       #UIAnimationsRunning:Z
    :cond_c
    const/4 v2, 0x0
    ...
    .local v11, df:Landroid/graphics/DrawFilter;
    iget-object v0, p0, Landroid/webkit/WebViewClassic;->mZoomManager:Landroid/webkit/ZoomManager;
    ...
    :cond_f
    iget-object v11, p0, Landroid/webkit/WebViewClassic;->mZoomFilter:Landroid/graphics/DrawFilter;

    :cond_10
    :goto_6
    invoke-virtual {p1, v11}, Landroid/graphics/Canvas;->setDrawFilter(Landroid/graphics/DrawFilter;)V
    ...
    iget-object v11, p0, Landroid/webkit/WebViewClassic;->mScrollFilter:Landroid/graphics/DrawFilter;
...
.method private native nativeCreateDrawGLFunction(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/RectF;FII)I
.end method
...
.method private pinScrollTo(IIZI)Z
    ...
    const-string v2, "videozaixian.com/"
...
.method private stopTouch()V
    ...
    invoke-virtual {p0}, Landroid/webkit/WebViewClassic;->contentInvalidatePartial()V
...
.method protected contentInvalidatePartial()V
    .locals 4

    .prologue
    iget-object v0, p0, Landroid/webkit/WebViewClassic;->mTimer:Ljava/util/Timer;
    ...
    iput-object v0, p0, Landroid/webkit/WebViewClassic;->mTimer:Ljava/util/Timer;

    :cond_0
    iget-object v0, p0, Landroid/webkit/WebViewClassic;->mTimer:Ljava/util/Timer;

    new-instance v1, Landroid/webkit/WebViewClassic$AnimationUpdateTask;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Landroid/webkit/WebViewClassic$AnimationUpdateTask;-><init>(Landroid/webkit/WebViewClassic;Landroid/webkit/WebViewClassic$1;)V
...
.method contentToViewY(I)I
    ...
    invoke-virtual {v0}, Landroid/webkit/WebSettingsClassic;->getDefaultfocusEnabled()Z
    ...
    iget-boolean v0, p0, Landroid/webkit/WebViewClassic;->mshouldmoveTotop:Z
...
.method public getCallbackProxy()Landroid/webkit/CallbackProxy;
    .locals 1
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iput-boolean v0, p0, Landroid/webkit/WebViewClassic;->mshouldmoveTotop:Z
...
.method onPageFinished(Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Landroid/webkit/WebSettingsClassic;->getLetvapkmoveFocus()I
    ...
    const-string v1, "javascript: var v=document.getElementsByTagName(\'video\')[0];if(null != v.readyState) window.LetvDefault.isYoukuVideopage(); "
...
.method onPageStarted(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2}, Landroid/webkit/WebView;->setCertificate(Landroid/net/http/SslCertificate;)V
    ...
    iget-boolean v0, p0, Landroid/webkit/WebViewClassic;->mshouldaddLetvJS:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/webkit/WebViewClassic;->mWebView:Landroid/webkit/WebView;

    new-instance v1, Landroid/webkit/WebViewClassic$LetvDefaultJavaScript;

    invoke-direct {v1, p0, v2}, Landroid/webkit/WebViewClassic$LetvDefaultJavaScript;-><init>(Landroid/webkit/WebViewClassic;Landroid/webkit/WebViewClassic$1;)V

    const-string v2, "LetvDefault"

    invoke-virtual {v0, v1, v2}, Landroid/webkit/WebView;->addJavascriptInterface(Ljava/lang/Object;Ljava/lang/String;)V

    iput-boolean v3, p0, Landroid/webkit/WebViewClassic;->mshouldaddLetvJS:Z
...
.method setNewPicture(Landroid/webkit/WebViewCore$DrawData;Z)V
    ...
    .local v3, scrollX:I
    :goto_3
    iget v4, v9, Landroid/webkit/WebViewCore$ViewState;->mScrollY:I
    ...
    :cond_7
    iget-object v10, p0, Landroid/webkit/WebViewClassic;->mWebViewCore:Landroid/webkit/WebViewCore;

    invoke-virtual {v10}, Landroid/webkit/WebViewCore;->getBrowserFrame()Landroid/webkit/BrowserFrame;

    move-result-object v10

    invoke-virtual {v10}, Landroid/webkit/BrowserFrame;->getOrientation()I

    move-result v5

    .local v5, tmp_Orientation:I
    iget-object v10, p0, Landroid/webkit/WebViewClassic;->mZoomManager:Landroid/webkit/ZoomManager;
    ...
    iget v10, p0, Landroid/webkit/WebViewClassic;->mPrev_Orientation:I

    if-eq v5, v10, :cond_9

    :cond_8
    iput v5, p0, Landroid/webkit/WebViewClassic;->mPrev_Orientation:I
    ...
    .end local v5           #tmp_Orientation:I
    ...
    :cond_e
    iget v3, v9, Landroid/webkit/WebViewCore$ViewState;->mScrollX:I
