.class public Lletv/widget/LetvSeekBar;
.super Landroid/widget/SeekBar;
.source "LetvSeekBar.java"
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, Lletv/widget/LetvSeekBar;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lletv/widget/LetvSeekBar;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method protected declared-synchronized onDraw(Landroid/graphics/Canvas;)V
    ...
    :try_start_0
    invoke-virtual {p0}, Lletv/widget/LetvSeekBar;->getProgress()I

    move-result v4

    .local v4, progress:I
    invoke-virtual {p0}, Lletv/widget/LetvSeekBar;->getSecondaryProgress()I

    move-result v6

    .local v6, sendcondProgress:I
    invoke-virtual {p0}, Lletv/widget/LetvSeekBar;->getProgressDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    :try_start_1
    invoke-virtual {p0}, Lletv/widget/LetvSeekBar;->getHeight()I

    move-result v7

    invoke-virtual {p0}, Lletv/widget/LetvSeekBar;->getPaddingTop()I

    move-result v8

    sub-int/2addr v7, v8

    invoke-virtual {p0}, Lletv/widget/LetvSeekBar;->getPaddingBottom()I
    ...
    .local v3, n:F
    invoke-virtual {p0}, Lletv/widget/LetvSeekBar;->getWidth()I
    ...
    invoke-virtual {p0}, Lletv/widget/LetvSeekBar;->getPaddingLeft()I
    ...
    invoke-virtual {p0}, Lletv/widget/LetvSeekBar;->getPaddingRight()I
    ...
    invoke-virtual {p0}, Lletv/widget/LetvSeekBar;->getMax()I
