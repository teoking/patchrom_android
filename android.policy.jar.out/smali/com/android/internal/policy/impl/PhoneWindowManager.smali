...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;,
...
.field private static final FILE_PATH:Ljava/lang/String; = "/system/etc/keymapping.txt"
...
.field private static final MSG_ENABLE_HOME_KEY:I = 0x5

.field private static final MSG_ENABLE_POINTER_LOCATION:I = 0x1

.field private static final MSG_ENABLE_SETTING_KEY:I = 0x6
...
.field mBlockFuncKeys:Z

.field mBlockHomeKey:Z

.field mBlockSettingKey:Z

.field mBlockSourceKey:Z

.field mBlockVoiceKey:Z
...
.field private mKeyTimer:Ljava/util/Timer;
...
.field private mMapKey:Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;

.field private mMapKeyList:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field private mMapKeyLongPress:Z

.field private mMapKeyTimerStarted:Z
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPreVolume:I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMapKeyList:Ljava/util/ArrayList;

    iput-object v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMapKey:Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;

    iput-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMapKeyLongPress:Z

    iput-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMapKeyTimerStarted:Z
...
.method static synthetic access$1000(Ljava/lang/String;Ljava/lang/String;)I
    .locals 1
    .parameter "x0"
    .parameter "x1"

    .prologue
    invoke-static {p0, p1}, Lcom/android/internal/policy/impl/PhoneWindowManager;->writeSysfs(Ljava/lang/String;Ljava/lang/String;)I
...
.method static synthetic access$1100(Lcom/android/internal/policy/impl/PhoneWindowManager;Landroid/os/IBinder;Landroid/view/WindowManagerPolicy$ScreenOnListener;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$500(Lcom/android/internal/policy/impl/PhoneWindowManager;)Z
    ...
    .prologue
    iget-boolean v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMapKeyTimerStarted:Z
...
.method static synthetic access$602(Lcom/android/internal/policy/impl/PhoneWindowManager;Z)Z
    ...
    .prologue
    iput-boolean p1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMapKeyLongPress:Z

    return p1
.end method

.method static synthetic access$700(Lcom/android/internal/policy/impl/PhoneWindowManager;)Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;
    .locals 1
    .parameter "x0"

    .prologue
    iget-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMapKey:Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;

    return-object v0
.end method

.method static synthetic access$800(Lcom/android/internal/policy/impl/PhoneWindowManager;IZ)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
    ...
    .prologue
    invoke-direct {p0, p1, p2}, Lcom/android/internal/policy/impl/PhoneWindowManager;->sendMapKey(IZ)V
...
.method private parseMapFile()V
    ...
    const-string v8, "/system/etc/keymapping.txt"
    ...
    new-instance v3, Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;

    invoke-direct {v3, p0}, Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;)V

    .local v3, key:Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;
    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "KEYCODE_"
    ...
    iput v6, v3, Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;->srcKey:I
    ...
    iput v6, v3, Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;->desKey:I
    ...
    iput v6, v3, Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;->longTime:I
    ...
    iput v6, v3, Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;->period:I

    iget v6, v3, Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;->srcKey:I

    if-eqz v6, :cond_1

    iget v6, v3, Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;->desKey:I
    ...
    const-string v7, "mapKey not found key code"
    ...
    .end local v3           #key:Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;
    ...
    const-string v8, "mapkey exception:"
    ...
    .restart local v3       #key:Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;
    .restart local v4       #line:Ljava/lang/String;
    .restart local v5       #strs:[Ljava/lang/String;
    :cond_3
    :try_start_4
    iget-object v6, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMapKeyList:Ljava/util/ArrayList;
...
.method private processMapKey(ZI)V
    .locals 6
    .parameter "down"
    .parameter "keyCode"

    .prologue
    iget-object v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMapKeyList:Ljava/util/ArrayList;
    ...
    const-string v3, "mapkey no map key list"
    ...
    .local v1, key:Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;
    const/4 v0, 0x0
    ...
    .end local v1           #key:Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;
    check-cast v1, Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;

    .restart local v1       #key:Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;
    iget v2, v1, Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;->srcKey:I
    ...
    iput-object v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMapKey:Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;

    if-eqz p1, :cond_4

    iget v2, v1, Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;->longTime:I

    int-to-long v2, v2

    iget v4, v1, Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;->period:I

    int-to-long v4, v4

    invoke-direct {p0, v2, v3, v4, v5}, Lcom/android/internal/policy/impl/PhoneWindowManager;->startSendKeyTimer(JJ)V
    ...
    :cond_4
    invoke-direct {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->stopSendKeyTimer()V

    iget v2, v1, Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;->desKey:I

    const/4 v3, 0x0

    invoke-direct {p0, v2, v3}, Lcom/android/internal/policy/impl/PhoneWindowManager;->sendMapKey(IZ)V
...
.method private sendMapKey(IZ)V
    .locals 12
    .parameter "keyCode"
    .parameter "actionDown"
    ...
    invoke-static {v4}, Landroid/hardware/input/IInputManager$Stub;->asInterface(Landroid/os/IBinder;)Landroid/hardware/input/IInputManager;

    move-result-object v4

    const/4 v5, 0x0

    invoke-interface {v4, v0, v5}, Landroid/hardware/input/IInputManager;->injectInputEvent(Landroid/view/InputEvent;I)Z
    ...
    .restart local v0       #down:Landroid/view/KeyEvent;
    .restart local v3       #up:Landroid/view/KeyEvent;
    :cond_0
    const-string v4, "input"
    ...
    invoke-interface {v4, v3, v5}, Landroid/hardware/input/IInputManager;->injectInputEvent(Landroid/view/InputEvent;I)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private startSendKeyTimer(JJ)V
    .locals 6
    .parameter "delay"
    .parameter "period"
    ...
    iput-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyTimer:Ljava/util/Timer;

    iget-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyTimer:Ljava/util/Timer;
    ...
    iput-boolean v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMapKeyTimerStarted:Z

    return-void
.end method

.method private stopSendKeyTimer()V
    .locals 1
...
.method public beginLayoutLw(ZIII)V
    ...
    .end local v18           #topIsFullscreen:Z
    :cond_1
    const-string v3, "persist.sys.hideStatusBar"
    ...
    .end local v14           #lp:Landroid/view/WindowManager$LayoutParams;
    :cond_d
    const-string v3, "sys.hideStatusBar.enable"
...
.method public finishPostLayoutPolicyLw()I
    ...
    const-string v6, "sys.statusbar.forcehide"
    ...
    invoke-interface {v6, v4}, Landroid/view/WindowManagerPolicy$WindowState;->showLw(Z)Z
    ...
    invoke-interface {v6, v4}, Landroid/view/WindowManagerPolicy$WindowState;->hideLw(Z)Z
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    iput-boolean v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHeadless:Z

    iget-boolean v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHeadless:Z

    if-nez v3, :cond_0

    new-instance v3, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;

    invoke-direct {v3, p1, v8}, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;-><init>(Landroid/content/Context;Lcom/android/internal/widget/LockPatternUtils;)V

    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyguardMediator:Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;

    :cond_0
    new-instance v3, Lcom/android/internal/policy/impl/PhoneWindowManager$PolicyHandler;

    invoke-direct {v3, p0, v8}, Lcom/android/internal/policy/impl/PhoneWindowManager$PolicyHandler;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;Lcom/android/internal/policy/impl/PhoneWindowManager$1;)V

    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHandler:Landroid/os/Handler;

    new-instance v3, Lcom/android/internal/policy/impl/PhoneWindowManager$MyOrientationListener;

    iget-object v6, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mContext:Landroid/content/Context;

    invoke-direct {v3, p0, v6}, Lcom/android/internal/policy/impl/PhoneWindowManager$MyOrientationListener;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;Landroid/content/Context;)V

    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mOrientationListener:Lcom/android/internal/policy/impl/PhoneWindowManager$MyOrientationListener;
    ...
    invoke-virtual {v3, v6}, Lcom/android/internal/policy/impl/PhoneWindowManager$MyOrientationListener;->setCurrentRotation(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mSettingsObserver:Lcom/android/internal/policy/impl/PhoneWindowManager$SettingsObserver;

    iget-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mSettingsObserver:Lcom/android/internal/policy/impl/PhoneWindowManager$SettingsObserver;

    invoke-virtual {v3}, Lcom/android/internal/policy/impl/PhoneWindowManager$SettingsObserver;->observe()V

    new-instance v3, Lcom/android/internal/policy/impl/ShortcutManager;

    iget-object v6, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHandler:Landroid/os/Handler;

    invoke-direct {v3, p1, v6}, Lcom/android/internal/policy/impl/ShortcutManager;-><init>(Landroid/content/Context;Landroid/os/Handler;)V

    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mShortcutManager:Lcom/android/internal/policy/impl/ShortcutManager;

    iget-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mShortcutManager:Lcom/android/internal/policy/impl/ShortcutManager;

    invoke-virtual {v3}, Lcom/android/internal/policy/impl/ShortcutManager;->observe()V
    ...
    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHomeIntent:Landroid/content/Intent;
    ...
    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mCarDockIntent:Landroid/content/Intent;
    ...
    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mDeskDockIntent:Landroid/content/Intent;
    ...
    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPowerManager:Landroid/os/PowerManager;
    ...
    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBroadcastWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-boolean v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mEnableShiftMenuBugReports:Z

    const v3, 0x10e000f

    invoke-direct {p0, v3}, Lcom/android/internal/policy/impl/PhoneWindowManager;->readRotation(I)I

    move-result v3

    iput v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLidOpenRotation:I
    ...
    iput v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mCarDockRotation:I
    ...
    iput v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mDeskDockRotation:I
    ...
    iput-boolean v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mCarDockEnablesAccelerometer:Z
    ...
    iput-boolean v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mDeskDockEnablesAccelerometer:Z
    ...
    iput v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLidKeyboardAccessibility:I
    ...
    iput v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLidNavigationAccessibility:I
    ...
    iget-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mDockReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mDockMode:I
    ...
    iget-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mDreamReceiver:Landroid/content/BroadcastReceiver;
    ...
    .restart local v0       #filter:Landroid/content/IntentFilter;
    iget-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMultiuserReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHdmiPluggedReceiver:Landroid/content/BroadcastReceiver;
    ...
    :goto_1
    iput-boolean v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHdmiPlugged:Z
    ...
    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVibrator:Landroid/os/Vibrator;
    ...
    invoke-static {v3, v4}, Lcom/android/internal/policy/impl/PhoneWindowManager;->getLongIntArray(Landroid/content/res/Resources;I)[J

    move-result-object v3

    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLongPressVibePattern:[J
    ...
    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVirtualKeyVibePattern:[J
    ...
    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyboardTapVibePattern:[J
    ...
    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mSafeModeDisabledVibePattern:[J
    ...
    iput-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mSafeModeEnabledVibePattern:[J
    ...
    iput-boolean v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mScreenshotChordEnabled:Z
    ...
    :goto_3
    invoke-direct {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->parseMapFile()V
    ...
    invoke-virtual {p0, v3}, Lcom/android/internal/policy/impl/PhoneWindowManager;->screenTurnedOff(I)V
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    .local v27, isScreenSaverOn:I
    :try_start_0
    const-string v3, "ScreenRetire"
    ...
    const-string v3, "com.amlogic.dvbplayer.homekey"

    move-object/from16 v0, v19

    invoke-direct {v0, v3}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .local v19, dvbplayer_homekey:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    .end local v19           #dvbplayer_homekey:Landroid/content/Intent;
    :cond_0
    const/16 v3, 0x7de
    ...
    const-string v3, "cn.com.wasu.main"

    const-string v5, "cn.com.wasu.main.WelcomeActivity"
    ...
    const-string v3, "cn.vtion.vmarkettv.tv.vstoresubclient"

    const-string v5, "cn.vtion.vmarkettv.tv.vstoresubclient.MainActivity"
    ...
    .end local v27           #isScreenSaverOn:I
    ...
    .restart local v27       #isScreenSaverOn:I
    ...
    :cond_7
    const-string v3, "tv.TvMenu_Runing_Flag"

    invoke-static {v3}, Landroid/os/SystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v12

    .local v12, Tvmenu_flag:Ljava/lang/String;
    const/4 v3, 0x3
    ...
    const-string v5, " TV Source filter HOME Key !"
    ...
    const-string v3, "android.intent.action.LETVKEY.TRIGGER"

    move-object/from16 v0, v46

    invoke-direct {v0, v3}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .local v46, trIntent:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    .end local v46           #trIntent:Landroid/content/Intent;
    :cond_8
    const-wide/16 v5, -0x1
    ...
    :cond_9
    const-string v3, "tv.tvstart_status"
    ...
    invoke-direct {v0, v3}, Lcom/android/internal/policy/impl/PhoneWindowManager;->sendKeyEvent(I)V

    :cond_a
    const-string v3, "WindowManager"

    const-string v5, " KEYCODE_CLEAR to KEYCODE_BACK!!!"
    ...
    :cond_b
    const-string v3, "ro.tv.shortcutkey"
    ...
    const-string v3, "com.amlogic.tv.tvmenu.stop"

    move-object/from16 v0, v42

    invoke-direct {v0, v3}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .local v42, stoptv:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    .end local v42           #stoptv:Landroid/content/Intent;
    :cond_c
    const/16 v3, 0x7d7
    ...
    const-string v3, "com.android.internal.policy.impl.KEY_DOWN_HAPPEN"
    ...
    .restart local v46       #trIntent:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    .end local v46           #trIntent:Landroid/content/Intent;
    :cond_e
    const-string v3, "tv.globalsetup_show_status"
    ...
    .restart local v26       #intent1:Landroid/content/Intent;
    const-string v3, "keyNum"
    ...
    const-string v6, "sendBroadcast KEY_DOWN_HAPPEN keycode="
    ...
    :cond_13
    const-string v3, "tv.shortcutkey_show"
    ...
    iget-boolean v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBlockHomeKey:Z

    if-eqz v3, :cond_17

    const-string v3, "WindowManager"

    const-string v5, "Ignoring HOME; Block HOME key explicitly."
    ...
    const-string v3, "com.letv.start.voice"

    move-object/from16 v0, v39

    invoke-direct {v0, v3}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .local v39, startVoiceIntent:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v3, v0, v5}, Landroid/content/Context;->sendOrderedBroadcast(Landroid/content/Intent;Ljava/lang/String;)V

    .end local v39           #startVoiceIntent:Landroid/content/Intent;
    :cond_32
    :goto_b
    if-eqz v27, :cond_33
    ...
    const-string v3, "com.letv.stop.voice"

    move-object/from16 v0, v41

    invoke-direct {v0, v3}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .local v41, stopVoiceIntent:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    .end local v41           #stopVoiceIntent:Landroid/content/Intent;
    :cond_35
    move-object/from16 v0, p0
    ...
    iget-boolean v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMapKeyLongPress:Z

    if-eqz v3, :cond_44

    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMapKey:Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;

    iget v3, v3, Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;->srcKey:I
    ...
    iput-boolean v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMapKeyLongPress:Z

    const/4 v3, 0x0

    move-object/from16 v0, p0

    iput-object v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mMapKey:Lcom/android/internal/policy/impl/PhoneWindowManager$MapKey;
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;IZ)I
    ...
    invoke-direct {v0, v7, v13}, Lcom/android/internal/policy/impl/PhoneWindowManager;->processMapKey(ZI)V
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isShowingAndNotHidden()Z
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isShowing()Z
    ...
    sget v23, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPreVolume:I
    ...
    invoke-virtual {v4, v0, v1, v2}, Landroid/media/AudioManager;->setStreamVolume(III)V
    ...
    sput v22, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPreVolume:I
    ...
    const-string v23, "ro.platform.has.mbxuimode"
    ...
    const-string v22, "com.android.music.musicservicecommand.pause"

    move-object/from16 v0, v22

    invoke-direct {v10, v0}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .local v10, inte:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    new-instance v15, Lcom/android/internal/policy/impl/PhoneWindowManager$16;

    move-object/from16 v0, p0

    invoke-direct {v15, v0}, Lcom/android/internal/policy/impl/PhoneWindowManager$16;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;)V

    .local v15, mAudioFocusListener:Landroid/media/AudioManager$OnAudioFocusChangeListener;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v0, v15, v1, v2}, Landroid/media/AudioManager;->requestAudioFocus(Landroid/media/AudioManager$OnAudioFocusChangeListener;II)I

    .end local v10           #inte:Landroid/content/Intent;
    .end local v15           #mAudioFocusListener:Landroid/media/AudioManager$OnAudioFocusChangeListener;
    .end local v16           #mAudioManager:Landroid/media/AudioManager;
    :cond_1b
    if-eqz p3, :cond_1c
    ...
    const-string v22, "com.amlogic.vplayer.powerkey"

    invoke-direct/range {v21 .. v22}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .local v21, vPlayerPowerKey:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    .end local v21           #vPlayerPowerKey:Landroid/content/Intent;
    :cond_23
    :goto_c
    const/16 v22, 0x0
    ...
    .end local v20           #telephonyService:Lcom/android/internal/telephony/ITelephony;
    :sswitch_6
    const-string v22, "sys.cold-reboot.enable"
    ...
    const-string v22, "ubootenv.var.suspend"
    ...
    const-string v23, "reboot system for cool reboot"
...
.method public layoutWindowLw(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/WindowManager$LayoutParams;Landroid/view/WindowManagerPolicy$WindowState;)V
    ...
    iget-object v2, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->GameList:Ljava/util/ArrayList;

    if-nez v2, :cond_4

    const-string v2, "WindowManager"

    const-string v3, "/system/etc/game_dimension_list.txt"
    ...
    iput-object v2, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->GameList:Ljava/util/ArrayList;
    ...
    const-string v6, "/system/etc/game_dimension_list.txt"
    ...
    .local v19, item:Lcom/android/internal/policy/impl/GameDimInfo;
    :goto_4
    ...
    .local v14, game:[Ljava/lang/String;
    const/4 v2, 0x1
    ...
    .local v13, dim:[Ljava/lang/String;
    const/4 v2, 0x0
    ...
    .local v15, h:I
    new-instance v19, Lcom/android/internal/policy/impl/GameDimInfo;

    .end local v19           #item:Lcom/android/internal/policy/impl/GameDimInfo;
    const/4 v2, 0x0
    ...
    invoke-direct {v0, v2, v1, v15}, Lcom/android/internal/policy/impl/GameDimInfo;-><init>(Ljava/lang/String;II)V

    .restart local v19       #item:Lcom/android/internal/policy/impl/GameDimInfo;
    move-object/from16 v0, p0
    ...
    .end local v13           #dim:[Ljava/lang/String;
    .end local v14           #game:[Ljava/lang/String;
    .end local v15           #h:I
    .end local v19           #item:Lcom/android/internal/policy/impl/GameDimInfo;
    ...
    check-cast v2, Lcom/android/internal/policy/impl/GameDimInfo;

    iget-object v2, v2, Lcom/android/internal/policy/impl/GameDimInfo;->name:Ljava/lang/String;
    ...
    iget v2, v2, Lcom/android/internal/policy/impl/GameDimInfo;->width:I
    ...
    iget v2, v2, Lcom/android/internal/policy/impl/GameDimInfo;->height:I
...
.method public screenTurningOn(Landroid/view/WindowManagerPolicy$ScreenOnListener;)V
    ...
    const-string v4, "ro.platform.has.cvbsmode"
    ...
    .local v0, cvbsHandler:Landroid/os/Handler;
    ...
    .end local v0           #cvbsHandler:Landroid/os/Handler;
    :cond_0
    const-string v4, "ro.platform.hdmionly"
    ...
    .local v2, hasHdmiOnly:Z
    if-eqz v2, :cond_1

    const-string v4, "ubootenv.var.outputmode"

    invoke-static {v4}, Landroid/os/SystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    .local v3, outputMode:Ljava/lang/String;
    ...
    const-string v4, "/sys/class/aml_mod/mod_off"

    const-string v6, "vdac"

    invoke-static {v4, v6}, Lcom/android/internal/policy/impl/PhoneWindowManager;->writeSysfs(Ljava/lang/String;Ljava/lang/String;)I

    .end local v3           #outputMode:Ljava/lang/String;
    :cond_1
    monitor-exit v5
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .end local v1           #hasCvbsOutput:Z
    .end local v2           #hasHdmiOnly:Z
    :catchall_0
    move-exception v4
...
.method public setBlockFunctionKeys(Z)V
    .locals 0
    .parameter "isBlock"

    .prologue
    iput-boolean p1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBlockFuncKeys:Z
...
.method public setBlockHomeKey(Z)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->setBlockHomeKeyTemporary(ZI)V

    return-void
.end method

.method public setBlockHomeKeyTemporary(ZI)V
    .locals 4
    .parameter "isBlock"
    .parameter "duration"
    ...
    iput-boolean p1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBlockHomeKey:Z
...
.method public setBlockSettingKey(Z)V
    .locals 0
    .parameter "isBlock"

    .prologue
    iput-boolean p1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBlockSettingKey:Z

    return-void
.end method

.method public setBlockSourceKey(Z)V
    .locals 0
    .parameter "isBlock"

    .prologue
    iput-boolean p1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBlockSourceKey:Z

    return-void
.end method

.method public setBlockVoiceKey(Z)V
    .locals 0
    .parameter "isBlock"

    .prologue
    iput-boolean p1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBlockVoiceKey:Z
