...
.field private static final SCREENSAVER_PROP:Ljava/lang/String; = "sys.screensaver.enable"
...
.method private getScreenOffTimeoutLocked()I
    ...
    .prologue
    const-string v2, "sys.screensaver.enable"
    ...
    const-string v2, "mbx.timeout.enable"
    ...
    .local v0, mMBXTimeoutEnable:Z
    if-nez v0, :cond_0

    const v2, 0x7fffffff

    .end local v0           #mMBXTimeoutEnable:Z
    :goto_0
    return v2
...
.method private isHdmiPlugged()Z
    .locals 10

    .prologue
    const/4 v6, 0x0

    const-string v1, "/sys/class/display/mode"

    .local v1, filename:Ljava/lang/String;
    const-string v2, "panel"

    .local v2, panel_str:Ljava/lang/String;
    const/4 v3, 0x0

    .local v3, plugged:Z
    const-string v7, "ro.vout.dualdisplay4"
    ...
    const-string v1, "/sys/class/display2/mode"
    ...
    const-string v9, "IO Exception when read: "
...
.method private readConfigurationLocked()V
    ...
    const-string v1, "sys.screensaver.enable"
...
.method private updatePowerStateLocked()V
    ...
    :cond_1
    const-string v4, "ro.platform.has.mbxuimode"
    ...
    invoke-direct {p0}, Lcom/android/server/power/PowerManagerService;->isHdmiPlugged()Z
...
.method public getDelayOfftime()I
    .locals 4
